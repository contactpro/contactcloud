...
###########################################################################################################
      ...
      def COMMAND_CENTER_STARTUP_SCREEN_black_blue(self): 
          ...
          self.entry_email.set("*** January 4, 2018 ") 
      ...
      def __init__(self, master, **kw):
            ...
            *List_of_Textbox_Edit_Modes, command=self.func_set_textbox_edit_mode_select_global)
            ...
            self.source_email_address_entry = Entry(self.master, \
                                                    textvariable = self.entry_SOURCE_EMAIL_ADDRESS, font = minilarge_font, width = 43)
            ...
            self.source_email_password_entry = Entry(self.master, \
                                                     textvariable = self.entry_SOURCE_EMAIL_PASSWORD, font = minilarge_font, width = 43)
            ...
            self.destination_1_email_address_entry = Entry(self.master, \
                                                           textvariable = self.entry_DEST_1_EMAIL_ADDRESS, font = minilarge_font, width = 43)
            ...
            self.destination_cc_email_address_entry = Entry(self.master, \
                                                            textvariable = self.entry_DEST_CC_EMAIL_ADDRESS, font = minilarge_font, width = 77)
            ...
            self.email_title_entry = Entry(self.master, \
                                           textvariable = self.entry_EMAIL_TITLE, font = minilarge_font, width = 77)
            ...
            self.email_status_entry = Entry(self.master, textvariable = self.entry_EMAIL_STATUS, font = ('Verdana',12), width = 100)
