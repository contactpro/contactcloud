...
# Version: 12.0 
#   
# Date: January 2, 2017 .... continue at line 7100 
#
...
###########################################################################################################
      ...
      def COMMAND_CENTER_STARTUP_SCREEN_black_blue(self): 
          ...
          self.entry_phonenum.set("*** Version 14.0 ")
          self.myentry7.config(background="black", fg="medium blue")
          self.entry_email.set("*** December 31, 2017 ") 
...
class System_Admin_Info(Frame):   # (object):
    def __init__(self, master):
        ...
        #  "DISPLAY EXCEPTIONS LOGFILE" changed to "SYSTEM ADMINISTRATION MENU" ......
        #  ADD OPTION MENU TO IMPLEMENT ipconfig and netstat commands  
        #
        # self.display_exceptions_logfile_Button = Button(self.master, text = "SYSTEM ADMINISTRATION MENU", width = 30, height = 2, \
        ...
        List_of_Sys_Admin_Modes = ["System Administration Menu", "System Administration Data", "ipconfig", "netstat", "Exceptions Logfile"]
...
#1234
    ...
    def set_mode_select_sysadmin_menu_global(self, mode_select_sysadmin_opt_menu_select):
        ...
        # "System Administration Menu", "System Administration Data", "ipconfig", "netstat", "Exceptions Logfile"
        #
        ...
        elif (mode_select_sysadmin_menu_global == "netstat"):
    ...
    def display_exceptions_logfile(self):
        ...
        # Not sure IF/WHY this line is needed as we use with open below .......
        self.textFile = open(fullpath_fn_cm_sw_app_logfile_global, 'r')
...
class Write_Exception_Logfile(object):
      ...
      def write_update_exception_logfile(self):
            with open(str(fullpath_exception_logfile_global), 'a') as exception_logfile:
                  ...
                  exception_logfile.write("\n_____________________________________________________________________________\n")
                  exception_logfile.write("\n" + ".... Contact  Management  Workstation  Enterprise  Cloud  Software  Application: *** Version 14.0 ***")
