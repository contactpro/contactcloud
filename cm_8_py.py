...
class Email_Gmail_Class(object):
      ...
      def dialog_to_get_file_attachment(self):
          ...
          ftypes = [
              ...
              ("PNG Files","*.png"),
              ("Bitmap Files","*.bmp"),
              ("MIDI Audio Files","*.mid"),
              ("MIDI Audio Files","*.rmi"),
              ("MP3 Audio Files","*.mp3"),
      ...
      def get_Textbox_File_for_OAUTH2_Email(self):
            ...
            if self.EMAIL_ATTACHMENT_OPTION_FLAG == False:
                # Create base64.urlsafe_b64encode of message - NO Attachment - Just the message body.
                ...
                #
                file_extension_MIME_Application_LIST = [
                    "doc",
                    "docx",
                    "gzip",
                    "kml",
                ...
                file_extension_MIME_Image_LIST = [
                    "bmp",
                    "jpe",
                    "jpeg",
                    "jpg",
                ...
                file_extension_MIME_Audio_LIST = [
                    "au",
                    "mid",
                    "m4a",
                    "mid",
                ...
                file_extension_MIME_Video_LIST = [
                    "avi",
                    "flv",
                    "mpe",
                    "mpeg",
                ...
                # ("Apple AIFF Audio Files","*.aiff"),
                # ("MPEGURL Audio Files","*.m3u"),
                # ("RealAudio Audio Files","*.ra"),
                # ("RealAudio Audio Files","*.ram"),
                # ("WAV Audio Files","*.wav"),
                # ("Windows Media Audio Files","*.wma"),
                # ("Apple Audio Files","*.iaff"),
                # ("Flash Video File","*.flv"),
                ...
                print(".... LOOPING BELOW .... selected_file_type at the LOOPS is: " + str(selected_file_type) + "\n")

                print(".... LOOPING BELOW .... main_type at the LOOPS is: " + str(main_type) + "\n")
                ...
                for index, item in enumerate(file_extension_MIME_Application_LIST, start = 1):
                    print(".... MIME_Application_LIST .... S E A R C H .... ")
                ...
                for index, item in enumerate(file_extension_MIME_Image_LIST, start = 1):
                    print(".... MIME_Image_LIST .... S E A R C H .... ")
                ...
                for index, item in enumerate(file_extension_MIME_Text_LIST, start = 1):
                    print(".... MIME Text_LIST .... S E A R C H .... ")
                ...
                for index, item in enumerate(file_extension_MIME_Audio_LIST, start = 1):
                    print(".... MIME_Audio_LIST .... S E A R C H .... ")
                ...
                for index, item in enumerate(file_extension_MIME_Video_LIST, start = 1):
                    print(".... MIME_Video_LIST .... S E A R C H .... ")
                ...
                if attachment_flow_flag == "MIMEApplication_FLOW":
                    self.MIME_message = self.email_attachment_MIMEApplication()
                elif attachment_flow_flag == "MIMEImage_FLOW":
                    self.MIME_message = self.email_attachment_MIMEImage()
                elif attachment_flow_flag == "MIMEText_FLOW":
                    self.MIME_message = self.email_attachment_MIMEText()
                elif attachment_flow_flag == "MIMEAudio_FLOW":
                    self.MIME_message = self.email_attachment_MIMEAudio()
                elif attachment_flow_flag == "MIMEVideo_FLOW":
                    self.MIME_message = self.email_attachment_MIMEVideo()
                elif attachment_flow_flag == "NO_FLOW_SET_YET":
                    self.MIME_message = self.email_attachment_MIME_Radio_Button_Select()
...
#1234567890123456
      ...
      def email_attachment_MIMEText(self):
            ...
            main_type = self.file_email_attachment_MAIN_TYPE
      ...
      def get_Textbox_File (self):
              ...
              # Load message into Class Variable Object
              # so we can use it to attach MIME Containers
              # in MIME attachment Methods.
              self.EMAIL_MESSAGE = message

              if self.EMAIL_ATTACHMENT_OPTION_FLAG == False:
                  # Create message for SMTP - NO Attachment - Just the message body.
                  ...
                  if attachment_flow_flag == "MIMEApplication_FLOW":
                      self.EMAIL_SMTP_message = self.email_attachment_MIMEApplication()
                  elif attachment_flow_flag == "MIMEImage_FLOW":
                      self.EMAIL_SMTP_message = self.email_attachment_MIMEImage()
                  elif attachment_flow_flag == "MIMEText_FLOW":
                      self.EMAIL_SMTP_message = self.email_attachment_MIMEText()
                  elif attachment_flow_flag == "MIMEAudio_FLOW":
                      self.EMAIL_SMTP_message = self.email_attachment_MIMEAudio()
                  elif attachment_flow_flag == "MIMEVideo_FLOW":
                      self.EMAIL_SMTP_message = self.email_attachment_MIMEVideo()
                  elif attachment_flow_flag == "NO_FLOW_SET_YET":
                      self.EMAIL_SMTP_message = self.email_attachment_MIME_Radio_Button_Select()
