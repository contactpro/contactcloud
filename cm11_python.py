...
class App(Frame):    #( object)
      ...
      def __init__(self, master):
            ...
            self.excel_import_export_button = Button(self.master, text = "Import / Export\nE x c e l", \
                  width=12,height=2, background="dark slate gray", fg = "light sea green", command = self.export_CSV_for_Excel)
            ...
            for c in scroll_label:
                  if r > 2 and r < 9:
                       if r == 3:
                             ...
                             background="midnight blue", fg = "deep sky blue", command = self.user_defined_gui_window)
...
###################################################################################### 
            ...
            self.sys_admin_view_button = Button(self.master, text = "System Administration\nand Database Information", \
                  width=25,height=3, font=('Helvetica', '14'), \
                  background="cyan4", command = self.system_administration_View)
...
###################################################################################### 
            ...
            self.app_media_button = Button(self.master, text = "EMAIL STARTUP", \
                ...
                activebackground="cyan", activeforeground="blue2", command = self.cm_app_doc_media_window)
...
###########################################################################################################
      ...
      def user_defined_gui_window(self):
            ...
            print("   ")
            print(".... After instantiating MEDICAL RECORD CLASS ... VIEWED from APP CLASS .... gui_group_three_object   " + str(gui_group_three_object) )
            print(".... After instantiating MEDICAL RECORD CLASS ... VIEWED from APP CLASS .... gui_group_two_object   " + str(gui_group_two_object) )
            print(".... After instantiating MEDICAL RECORD CLASS ... VIEWED from APP CLASS .... gui_group_one_object   " + str(gui_group_one_object) )
            print("   ")
      ...
      def system_administration_View(self):
            global fullpath_fn_cm_sw_app_logfile_global
            global instance_object_LIST
            global instance_object_winfo_id_LIST
            global instance_object_winfo_parent_LIST
            ...
            # 
            # Examine the INSTANCE: self.cm_app_sys_admin
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_sys_admin
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def new_window(self):
            ...
            # 
            # Examine the INSTANCE:  self.cm_app_select_contact_list
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_select_contact_list
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def select_App_Status_Display(self):
            ...
            # 
            # Examine the INSTANCE: self.cm_app_status_panel
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_status_panel
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def new_list_window(self):
            ...
            #  
            # Examine the INSTANCE:  self.cm_app_new_contact_list
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_new_contact_list
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def view_mode(self):
            ...
            # 
            # Examine the INSTANCE:  self.cm_app_view_contact_list
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_view_contact_list
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def export_CSV_for_Excel(self):
            ...
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_excel_import_export
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        #
        # Change Code below ........ to something like: if  str(gui_group_three_object) in str(self.master):

        user_defined_gui_instance_count_GLOBAL
...
################################################################################################# 
      ...
      # 
      # Examine the INSTANCE: cm_app
      #
      # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
      #
      instance_object_focus = cm_app
      instance_object_LIST.append(str(instance_object_focus) )
      instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
      instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
      print("  ")
