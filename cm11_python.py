...
###########################################################################################################
      ...
      def cm_app_doc_media_window(self):
            ...
            # 
            # Examine the INSTANCE: self.cm_app_doc_media
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_doc_media
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
            print(".... str(instance_object_focus) = " + str(instance_object_focus) )
            print(".... str(instance_object_focus.winfo_id() ) = " + str(instance_object_focus.winfo_id() ) )
            print(".... str(instance_object_focus.winfo_parent() ) = " + str(instance_object_focus.winfo_parent() ) )
            print("  ")
      ...
      def user_defined_gui_window(self):
            ...
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = user_defined_gui_group_one
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
            ...
            # 
            # Examine the INSTANCE: user_defined_gui_group_two
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = user_defined_gui_group_two
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
            ...
            # 
            # Examine the INSTANCE: user_defined_gui_group_three
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = user_defined_gui_group_three
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def user_manual_View(self):
            ...
            # 
            # Examine the INSTANCE: self.cm_app
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def email_Gmail_Feature(self):
            ...
            # 
            # Examine the INSTANCE: self.cm_app_email
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_email
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
      ...
      def build_list_from_dual_listbox_window(self):
            ...
            # 
            # Examine the INSTANCE: self.cm_app_dual_listbox
            #
            # Gather this information acquired in a LIST to Control CYCLING WINDOWS ....
            #
            instance_object_focus = self.cm_app_dual_listbox
            instance_object_LIST.append(str(instance_object_focus) )
            instance_object_winfo_id_LIST.append(str(instance_object_focus.winfo_id() ))
            instance_object_winfo_parent_LIST.append(str(instance_object_focus.winfo_parent() ))
            print("  ")
...
##################################################################################################
#
class Demo2_List_Builder(Frame):  #(object):
    def __init__(self, master):
        global cm_listbox_file_global
        global dict_filename_global
        global cnotes_dict_file_global
...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        print("  ") 
        print("RIGHT BEFORE VERY FIRST .... fullpath_med_config_ini_global = " + str(fullpath_med_config_ini_global) )
        
        if os.path.isfile(fullpath_med_config_ini_global) == False:
            self.very_first_create_medical_record_config_ini()
            print("  ")
            print(".... CREATING VERY FIRST ... medical_record_config.ini")
