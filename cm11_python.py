...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        user_label_text_setting = "Insulin - mU/L (Fasting)"
        status_message_text_setting = "Enter Fasting Insulin Level below ..."
        user_button_text_setting = "Record Insulin"

        # Instantiate FIRST GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame1)  
        for r in range(4):
            self.Frame1.rowconfigure(r, weight=1)    
            self.Frame1.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame1, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_1_stringvar, user_button_text_setting)

        user_label_text_setting = "Insulin Resistance - mU/L (2 hrs)"
        status_message_text_setting = "Enter Insulin Resistance below ..."
        user_button_text_setting = "Record Insulin Resistance"

        # Instantiate SECOND GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame2)
        for r in range(4):
            self.Frame2.rowconfigure(r, weight=1)    
            self.Frame2.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame2, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_2_stringvar, user_button_text_setting)

        user_label_text_setting = "Glucose - mg/dL (Fasting)"
        status_message_text_setting = "Enter Fasting Glucode Level below ..."
        user_button_text_setting = "Record Glucose"
        
        # Instantiate THIRD GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame3)
        for r in range(4):
            self.Frame3.rowconfigure(r, weight=1)    
            self.Frame3.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame3, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_3_stringvar, user_button_text_setting)

        user_label_text_setting = "Glucose Response - mg/dL (2 hrs)"
        status_message_text_setting = "Enter Glucode Response below ..."
        user_button_text_setting = "Record Glucose Response"

        # Instantiate FOURTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame4, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_4_stringvar, user_button_text_setting)

        user_label_text_setting = "LDL-Cholesterol"
        status_message_text_setting = "Enter LDL-Cholesterol below ..."
        user_button_text_setting = "Record LDL-Cholesterol"
        
        # Instantiate FIFTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame5) 
        for r in range(4):
            self.Frame5.rowconfigure(r, weight=1)    
            self.Frame5.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame5, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_5_stringvar, user_button_text_setting)

        user_label_text_setting = "Total Cholesterol"
        status_message_text_setting = "Enter Total Cholesterol below ..."
        user_button_text_setting = "Record Total Cholesterol"

        # Instantiate SIXTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame6, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_6_stringvar, user_button_text_setting)

        user_label_text_setting = "HDL-Cholesterol"
        status_message_text_setting = "Enter HDL-Cholesterol below ..."
        user_button_text_setting = "Record HDL-Cholesterol"

        # Instantiate SEVENTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame7)
        for r in range(4):
            self.Frame7.rowconfigure(r, weight=1)    
            self.Frame7.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame7, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_7_stringvar, user_button_text_setting)

        user_label_text_setting = "Triglycerides"
        status_message_text_setting = "Enter Triglycerides below ..."
        user_button_text_setting = "Record Triglycerides"

        # Instantiate EIGHTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        # using method - self.widget_group_template(self.Frame8) 
        for r in range(4):
            self.Frame8.rowconfigure(r, weight=1)    
            self.Frame8.columnconfigure(0, weight=1)

        self.widget_group_template(self.Frame8, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_8_stringvar, user_button_text_setting)

        user_label_text_setting = "Body Weight"
        status_message_text_setting = "Enter Body Weight below ..."
        user_button_text_setting = "Record Body Weight"

        # Instantiate NINTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame9, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_9_stringvar, user_button_text_setting)

        user_label_text_setting = "Body Height"
        status_message_text_setting = "Enter Body Height below ..."
        user_button_text_setting = "Record Body Height"

        # Instantiate TENTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame10, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_10_stringvar, user_button_text_setting)

        user_label_text_setting = "Resting Heart Rate"
        status_message_text_setting = "Enter Resting Heart Rate below ..."
        user_button_text_setting = "Record Resting Heart Rate"

        # Instantiate ELEVENTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame11, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_11_stringvar, user_button_text_setting)

        user_label_text_setting = "Blood Press - (Sys/Dias) - mm Hg"
        status_message_text_setting = "Enter Blood Pressure below ..."
        user_button_text_setting = "Record Blood Pressure"

        # Instantiate TWELVTH GROUP of FOUR USER GUI WIDGETS (Label, Entry, Text, Button)
        ...
        self.widget_group_template(self.Frame12, user_label_text_setting, status_message_text_setting, \
                                   self.user_entry_12_stringvar, user_button_text_setting)
