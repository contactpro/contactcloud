...
OBJECT_toplevel_user_gui_config_class = object
...
OBJECT_IN_APP_user_gui_config_class = object
...
class App(Frame):    #( object)
      ...
      def __init__(self, master):
            ...
            global OBJECT_IN_APP_user_gui_config_class
            ...
            OBJECT_IN_APP_user_gui_config_class = self.master
...
######################################################################################
            ...
            List_of_WINDOWS = ["WINDOW SELECT", "cm_app_doc_media", "excel_import_export", "app_status_panel", \
                               ...
                               "MEDICAL RECORD", "Command Center Startup", "E X I T"]
...
###########################################################################################################
      ...
      def func_set_window_select_global(self, window_select_opt_menu_select):
             ...
             elif (window_select_global == "Command Center Startup"):
      ...
      def COMMAND_CENTER_STARTUP_method(self):
          print("  ")
          print(".... Executing:  COMMAND CENTER STARTUP method .......... ")
          print("  ")
...
class Email_Gmail_Class(Frame):  #(object):
      ...
      def lower_email_WINDOW(self):
          ...
          if (OBJECT_toplevel_system_admin_info.winfo_exists() ) == True:
              OBJECT_toplevel_system_admin_info.lift()

          elif (OBJECT_toplevel_view_contact_list.winfo_exists() ) == True:
              OBJECT_toplevel_view_contact_list.lift()

          elif (OBJECT_toplevel_config_setting_class.winfo_exists() ) == True:
              OBJECT_toplevel_config_setting_class.lift()

          elif (OBJECT_toplevel_user_gui_config_class.winfo_exists() ) == True:
              OBJECT_toplevel_user_gui_config_class.lift()

          elif (OBJECT_toplevel_select_contact_list.winfo_exists() ) == True:
              OBJECT_toplevel_select_contact_list.lift()

          elif (OBJECT_toplevel_new_contact_list.winfo_exists() ) == True:
              OBJECT_toplevel_new_contact_list.lift()

          elif (OBJECT_toplevel_list_builder.winfo_exists() ) == True:
              OBJECT_toplevel_list_builder.lift()

          elif (OBJECT_toplevel_cm_app_doc_media.winfo_exists() ) == True:
              OBJECT_toplevel_cm_app_doc_media.lift()

          elif (OBJECT_toplevel_excel_import_export.winfo_exists() ) == True:
              OBJECT_toplevel_excel_import_export.lift()

          elif (OBJECT_toplevel_app_status_panel.winfo_exists() ) == True:
              OBJECT_toplevel_app_status_panel.lift()

          elif (OBJECT_toplevel_email_gmail_class.winfo_exists() ) == True:
...
############################################################################################### 
    ...
    def lower_WINDOW(self):
        ...
        if (OBJECT_toplevel_app_status_panel.winfo_exists() ) == True:
            OBJECT_toplevel_app_status_panel.lift()
        ...
        elif (OBJECT_toplevel_system_admin_info.winfo_exists() ) == True:
            OBJECT_toplevel_system_admin_info.lift()
...
class System_Admin_Info(Frame):   # (object):
    ...
    def lower_WINDOW(self):
        ...
        if (OBJECT_toplevel_view_contact_list.winfo_exists() ) == True:
            OBJECT_toplevel_view_contact_list.lift()
...
#12345678
    ...
    def lower_the_window(self):
        ...
        if (OBJECT_toplevel_select_contact_list.winfo_exists() ) == True:
            OBJECT_toplevel_select_contact_list.lift()
...
class CM_App_Doc_Media(Frame):  #(object):
    ...
    def lower_email_WINDOW(self):
        ...
        if (OBJECT_toplevel_excel_import_export.winfo_exists() ) == True:
            OBJECT_toplevel_excel_import_export.lift()
