...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        # Test MUX with dummy data for GROUP #2 AND #3  (#1 is real data)

        group3_frame1_user_label = "group3_frame1_user_label"
        group3_frame1_status_text = "group3_frame1_status_text"
        group3_frame1_user_button = "group3_frame1_user_button"
        
        group2_frame1_user_label = "group2_frame1_user_label"
        group2_frame1_status_text = "group2_frame1_status_text"
        group2_frame1_user_button = "group2_frame1_user_button"
        ...
        group3_frame2_user_label = "group3_frame2_user_label"
        group3_frame2_status_text = "group3_frame2_status_text"
        group3_frame2_user_button = "group3_frame2_user_button"
        
        group2_frame2_user_label = "group2_frame2_user_label"
        group2_frame2_status_text = "group2_frame2_status_text"
        group2_frame2_user_button = "group2_frame2_user_button"
        ...
        group3_frame3_user_label = "group3_frame3_user_label"
        group3_frame3_status_text = "group3_frame3_status_text"
        group3_frame3_user_button = "group3_frame3_user_button"
        
        group2_frame3_user_label = "group2_frame3_user_label"
        group2_frame3_status_text = "group2_frame3_status_text"
        group2_frame3_user_button = "group2_frame3_user_button"
        ...
        group3_frame4_user_label = "group3_frame4_user_label"
        group3_frame4_status_text = "group3_frame4_status_text"
        group3_frame4_user_button = "group3_frame4_user_button"
        
        group2_frame4_user_label = "group2_frame4_user_label"
        group2_frame4_status_text = "group2_frame4_status_text"
        group2_frame4_user_button = "group2_frame4_user_button"
    ...
    def update_user_text_status(self, event):
        ...
        # NOTE: WE MUST ALSO CAPTURE THE INSTANCES FOR THIS
        # SO WE DELETE THE CORRECT ENTRY WIDGET AS WE TRANSFER
        # THE DATA TO THE STATUS OR TEXT WIDGET ...... 
        # Delete Entry Widget after we have captured data for Status Text Widget
        #
...
#################################################################################################
      ...
      if os.path.isfile(fullpath_app_config_ini_global) == False:
            ...
            config.set("USER_DESIGNS_GUI", "group3_frame1_user_label", "Insulin - mU/L (Fasting)")
            config.set("USER_DESIGNS_GUI", "group3_frame1_status_text", "Enter Fasting Insulin Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame1_user_button", "Record Insulin")
            config.set("USER_DESIGNS_GUI", "group3_frame2_user_label", "Insulin Resistance - mU/L (2 hrs)")
            config.set("USER_DESIGNS_GUI", "group3_frame2_status_text", "Enter Insulin Resistance below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame2_user_button", "Record Insulin Resistance")
            config.set("USER_DESIGNS_GUI", "group3_frame3_user_label", "Glucose - mg/dL (Fasting)")
            config.set("USER_DESIGNS_GUI", "group3_frame3_status_text", "Enter Glucose Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame3_user_button", "Record Glucose")
            config.set("USER_DESIGNS_GUI", "group3_frame4_user_label", "Glucose Response - mg/dL (2 hrs)")
            config.set("USER_DESIGNS_GUI", "group3_frame4_status_text", "Enter Glucose Response below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame4_user_button", "Record Glucose Response")
            config.set("USER_DESIGNS_GUI", "group3_frame5_user_label", "LDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame5_status_text", "Enter LDL-Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame5_user_button", "Record LDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame6_user_label", "Total Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame6_status_text", "Enter Total Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame6_user_button", "Record Total Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame7_user_label", "HDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame7_status_text", "Enter HDL-Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame7_user_button", "Record HDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group3_frame8_user_label", "Triglycerides")
            config.set("USER_DESIGNS_GUI", "group3_frame8_status_text", "Enter Triglycerides below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame8_user_button", "Record Triglycerides")
            config.set("USER_DESIGNS_GUI", "group3_frame9_user_label", "Body Weight")
            config.set("USER_DESIGNS_GUI", "group3_frame9_status_text", "Enter Body Weight below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame9_user_button", "Record Body Weight")
            config.set("USER_DESIGNS_GUI", "group3_frame10_user_label", "Body Height")
            config.set("USER_DESIGNS_GUI", "group3_frame10_status_text", "Enter Body Height below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame10_user_button", "Record Body Height")
            config.set("USER_DESIGNS_GUI", "group3_frame11_user_label", "Resting Heart Rate")
            config.set("USER_DESIGNS_GUI", "group3_frame11_status_text", "Enter Resting Heart Rate below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame11_user_button", "Record Resting Heart Rate")
            config.set("USER_DESIGNS_GUI", "group3_frame12_user_label", "Blood Press - (Sys/Dias) - mm Hg")
            config.set("USER_DESIGNS_GUI", "group3_frame12_status_text", "Enter Blood Pressure below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame12_user_button", "Record Blood Pressure")
