...
#
# Description: Contact Management Workstation Application Software
#
...
user_gui_x_col_frames_value_global = "USER GUI DATA Not Set"
user_gui_y_row_frames_value_global = "USER GUI DATA Not Set"
...
gui_group_one_object = ""
gui_group_two_object = ""
gui_group_three_object = ""
user_defined_gui_group_one = ""
user_defined_gui_group_two = ""
user_defined_gui_group_three = ""
USER_GUI_Config_Class_group_one_inst = ""
USER_GUI_Config_Class_group_two_inst = ""
USER_GUI_Config_Class_group_three_inst = ""
...
class App(object):
      ...
      def __init__(self, master):
            ...
            global USER_GUI_Config_Class_group_one_inst
            global USER_GUI_Config_Class_group_two_inst
            global USER_GUI_Config_Class_group_three_inst
            ...
            self.excel_import_export_button = Button(self.master, text = "Import / Export\nE x c e l", \
                  width=12,height=2, font=('Times', '12'), \
                  background="light sea green", command = self.export_CSV_for_Excel)

            self.excel_import_export_button.grid(row=1, column=0, sticky=W)
            self.excel_import_export_button.config(borderwidth=5, background="light sea green", font=('Helvetica', 14 ) )
            self.excel_import_export_button.config(borderwidth=5, activebackground="cyan4", activeforeground="cyan")
            ...
            *List_of_Program_Modes, command=self.func_set_mode_select_global)
            ...
            self.sort_contact_list_button.config(activebackground="cyan4", activeforeground="cyan")

            self.insert_button = Button(self.master, text = "CONTACT NOTES\nEMAIL   ( Gmail )", \
                  width=30,height=3, font=('Helvetica', '12'), \
                  background="cyan4", command = self.email_Gmail_Feature)
            ...
            self.config_button = Button(self.master, text = "CONFIGURE APP SETTINGS", \
                  width=30,height=3, font=('Helvetica', '12'), \
                  background="cyan4", command = self.config_App_Settings)
            ...
            self.new_window_button = Button(self.master, text = "SELECT\nContact\nList", \
                  ...
                  fg = "light sea green", command = self.new_window)
...
###########################################################################################
            ...
            for c in scroll_label:
                  if r > 2 and r < 9:
                       if r == 3:
                             bindto = "forward_fast"
                             speedbutton_1 = Button(self.master, text = c, \
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.forward_fast)
                             ...
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.forward_scroll)
                             ...
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.forward_tick)
                             ...
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.backward_tick)
                             ...
                             speedbutton_5 = Button(self.master, text = "User Defined", \
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.user_defined_gui_window)
                             speedbutton_5.grid(row=r,column=0, sticky=W)
                             speedbutton_5.config(borderwidth=5)
                             ...
                             width=12,height=2, font=medium_font, \
                             background="cyan4", fg = "cyan", command = self.insert_Data_Entry)
                             speedbutton_6.grid(row=r,column=0, sticky=W)
                             speedbutton_6.config(borderwidth=5)
...
######################################################################################
            ...
            #                        width=30,height=3, font=('Helvetica', '12'), \
            #                          background="cyan4", command = self.exit_Handler)
            # 
            # self.quitbutton.grid(row=12, column=0, sticky=W)
            # self.quitbutton.config(borderwidth=5, activebackground="cyan4", activeforeground="cyan")

            #
            # LOWER WINDOW BUTTON.   
            # 
            self.lower_window_Button = Button(self.master, text = "CYCLE", width = 7, height = 1, \
                font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5, \
                activebackground="cyan", activeforeground="blue2", command = self.lower_main_WINDOW)

            self.lower_window_Button.grid(row=12, column=0) # sticky = E
...
######################################################################################
            ...
            self.user_manual_button = Button(self.master, text = "USERS MANUAL\nand System Administration", \
                  width=30,height=3, font=('Helvetica', '12'), \
                  background="cyan4", command = self.user_manual_View)
            
            self.user_manual_button.grid(row=12, column=1, sticky=W)
            self.user_manual_button.config(borderwidth=5, activebackground="cyan4", activeforeground="cyan")
...
######################################################################################
            ...
            self.app_status_display_select_button.config(activebackground="cyan4", activeforeground="cyan")

###################################################################################### 

            self.app_media_button = Button(self.master, text = "EMAIL STARTUP", \
                width=14, height=1, command = self.cm_app_doc_media_window)
            
            self.app_media_button.grid(row=3, column=0, sticky=E)
            self.app_media_button.config(borderwidth=5, background="light sea green", font=('Helvetica', 14 ) )
            self.app_media_button.config(activebackground="cyan4", activeforeground="cyan")
            
######################################################################################

            self.buildlistbutton = Button(self.master, text = "NEW\nContact\nList", \
                                   width=8, height=3, font=minilarge_font, \
                                   background="dark slate gray", fg = "light sea green", command = self.new_list_window)
...
###################################################################################### 
            ...
            self.build_dual_list_button = Button(self.master, text = "BUILD List", \
                                   ...
                                   background="dark slate gray", fg = "light sea green", command = self.build_list_from_dual_listbox_window)
            
            self.build_dual_list_button.grid(row=8, column=0, sticky=E)
            self.build_dual_list_button.config(borderwidth=5, activebackground="cyan4", activeforeground="cyan")

######################################################################################  

            self.view_mode_button = Button(self.master, text = "VIEW\nContact\nList", \
                                   width=8, height=3, font=minilarge_font, \
                                   background="dark slate gray", fg = "light sea green", command = self.view_mode)
...
######################################################################################
            ...
            self.mylabel.config(bg='cyan4', fg='gray25')  
...
###########################################################################################################
            ...
            # print(".... at END OF main INIT .... selected_dictionary_record_index_global = " + str(selected_dictionary_record_index_global) )

            # print(".... at END OF main INIT .... selected_dictionary_record_index_focus_global = " + str(selected_dictionary_record_index_focus_global) )
      ...
      # 
      def cm_app_doc_media_window(self):
      ...
      #####################################################################################
      #
      # Method to open new window for User GUI Configuration Class. 
      # 
      def user_defined_gui_window(self):
            global USER_GUI_Config_Class_inst_LIST
            global gui_group_one_object
            global gui_group_two_object
            global gui_group_three_object
            ...
            # Gather USER_GUI_Config_Class Instances to capture instance names to use to address WIDGETS.
            USER_GUI_Config_Class_inst_LIST.append(user_defined_gui_group_one)
            ...
            # Gather USER_GUI_Config_Class Instances to capture instance names to use to address WIDGETS.
            USER_GUI_Config_Class_inst_LIST.append(user_defined_gui_group_two)
            ...
            # Gather USER_GUI_Config_Class Instances to capture instance names to use to address WIDGETS.
            USER_GUI_Config_Class_inst_LIST.append(user_defined_gui_group_three)

            class_instance_counter = 1
            for class_instance in USER_GUI_Config_Class_inst_LIST:
                if class_instance_counter == 1:
                    USER_GUI_Config_Class_group_one_inst = class_instance
                elif class_instance_counter == 2:
                    USER_GUI_Config_Class_group_two_inst = class_instance
                elif class_instance_counter == 3:
                    USER_GUI_Config_Class_group_three_inst = class_instance

                class_instance_counter+=1

                print("  ") 
                print(".... VIEWED from Class App - List of USER_GUI_Config_Class instances = " + str(class_instance) )
                print("  ")
            ...
            widget_object_focus_one = user_defined_gui_group_one # A global: user_defined_gui_group_one
            print("  ")
            print(".... str(widget_object_focus_one) = " + str(widget_object_focus_one) )
            print(".... str(widget_object_focus_one.winfo_id() ) = " + str(widget_object_focus_one.winfo_id() ) )
            print(".... str(widget_object_focus_one.winfo_parent() ) = " + str(widget_object_focus_one.winfo_parent() ) )
            print("  ")
            
            widget_object_focus_two = user_defined_gui_group_two # A global: user_defined_gui_group_two
            print(".... str(widget_object_focus_two) = " + str(widget_object_focus_two) )
            print(".... str(widget_object_focus_two.winfo_id() ) = " + str(widget_object_focus_two.winfo_id() ) )
            print(".... str(widget_object_focus_two.winfo_parent() ) = " + str(widget_object_focus_two.winfo_parent() ) )
            print("  ")
            
            widget_object_focus_three = user_defined_gui_group_three # A global: user_defined_gui_group_three
            print(".... str(widget_object_focus_three) = " + str(widget_object_focus_three) )
            print(".... str(widget_object_focus_three.winfo_id() ) = " + str(widget_object_focus_three.winfo_id() ) )
            print(".... str(widget_object_focus_three.winfo_parent() ) = " + str(widget_object_focus_three.winfo_parent() ) )
            print("  ")
      ...
      def build_list_from_dual_listbox_window(self):
             global selected_dictionary_record_index_global
             global selected_dictionary_record_index_focus_global
             self.entry_first.set(str("") )
             self.entry_first.set(str("") )
             ...
             self.cm_app_dual_listbox = Demo2_List_Builder(self.build_list_dual_listbox_window)
...
#1234567890123456
                try:
                    ...
                    # Launch CM_App_Doc_Media Class when Email FAILS to Instruct USER How to set up Email.
                    # self.launch_messagebox_when_email_fails()  

                    self.email_fail_launch_media_WINDOW = tk.Toplevel(self.master)
                    self.email_fail_launch_media = CM_App_Doc_Media(self.email_fail_launch_media_WINDOW)
...
#1234567890123456                     
                ...
                try:
                    ...
                    self.email_fail_smtp_launch_media_WINDOW = tk.Toplevel(self.master)
                    self.email_fail_smtp_launch_media = CM_App_Doc_Media(self.email_fail_smtp_launch_media_WINDOW)
...
class App_Status_Class(Frame):    #( object)
    def __init__(self, master=None):
        ...
        #
        self.tk_lower_status_panel_Button = Button(self.master, text = "CYCLE", \
...
class Demo2(object):
    def __init__(self, master):
        ...
        background="cyan4", fg="black", activebackground="cyan", activeforeground="blue2", \
        command = self.lower_the_window)
        self.tk_lower_status_panel_Button.grid(row=4, column=0, padx=5, pady=5, sticky = S)  
        self.tk_lower_status_panel_Button.config(borderwidth=5)
    ...
    def get_Listbox_File(self):
        ...
        split_cn_fn_string = cm_fn_string.split("dict_file_")[1]
...
##################################################################################################
#
class Demo2_List_Builder(object):
    def __init__(self, master):
        global cm_listbox_file_global
        global dict_filename_global
        global cnotes_dict_file_global
        ...
        self.master.title("Contact Management Application Software - BUILD Contact List from Existing Contact List")
    ...
    def draw_WorkFlow_Canvas_Widget(self):
        ...
        # CLEAR LISTBOX ONE TO REFRESH FILES TO RESET PROGRAM FOR NEXT BUILD WORKFLOW TASK.
        # DO NOT CLEAR LISTBOX TWO and LISTBOX THREE because those LISTBOXES have USER Data in them.
        self.lbox.delete(0, END)

        # Load all dict_file_XXXXX.txt files from cm_appdatafiles_path_global directory into the LISTBOX
        results = []
        ...
        for root,dirs,files in os.walk(testdir):
            for f in files:
                 if ( (f.endswith('.txt') and ("dict_file_" in str(f) ) ) ):
                     ...
                     try:
                           split_cm_list_see_bracket_ONE = f.split("dict_file_")[1]
                           #  print(".... f.split(dict_file_)[1] = " + str(split_cm_list_see_bracket_ONE) )
                           target_filename_string = split_cm_list_see_bracket_ONE.split(".txt")[0]
                           #  print(".... target_filename_string = " + str( target_filename_string) )
...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        print(".... self.master = " + str(self.master) )

        if "toplevel3" in str(self.master):
            gui_group_three_object = self.master
            self.master.title("Contact Management Application Software - User-Defined Graphical User Interface:   U S E R - D E F I N E D   G U I  -  G R O U P   T H R E E")
        elif "toplevel2" in str(self.master):
            gui_group_two_object = self.master
            self.master.title("Contact Management Application Software - User-Defined Graphical User Interface:   U S E R - D E F I N E D   G U I  -  G R O U P   T W O")
        else:
            gui_group_one_object = self.master
            self.master.title("Contact Management Application Software - User-Defined Graphical User Interface:   U S E R - D E F I N E D   G U I  -  G R O U P   O N E")
        ...
        #####################################################################
        #
        # Load the medical_record.ini file to initialize all the globals
        #
        #####################################################################
        #
        ...
        num_x_col_frames = int(user_gui_x_col_frames_value_global)
        num_y_row_frames = int(user_gui_y_row_frames_value_global)
        ...
        # LOWER WINDOW BUTTON. 
        # 
        self.lower_window_Button = Button(self.master, text = "CYCLE", width = 6, height = 1, \
            font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2", command = self.lower_this_WINDOW)
        ...
        # EXIT BUTTON.  
        # 
        self.quitButton = Button(self.master, text = "EXIT", width = 6, height = 1, \
            font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2", command = self.exit_Handler)
        ...
        # 
        self.group_one_window_Button = Button(self.master, text = "Group One\nSelect", width = 10, height = 2, \
            font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2")  # command = self.lift_group_one_WINDOW)
        self.group_one_window_Button.bind("<Button-1>", self.lift_group_one_WINDOW)
        self.group_one_window_Button.grid(row=12, column=1)

        #
        # GROUP #1 WINDOW SIGNAL BUTTON. event_generate IF self.master indicates GROUP #1 WINDOW SELECTED.
        #  
        self.group_one_window_signal_label = Label(self.master, width = 10, height = 1, \
            font=('Helvetica', '8'), background="cyan4", fg="black", borderwidth=5, relief="raised")
        self.group_one_window_signal_label.grid(row=13, column=1)

        #
        # GROUP #2 WINDOW SELECT BUTTON. global USER_GUI_Config_Class_inst_LIST
        # 
        self.group_two_window_Button = Button(self.master, text = "Group Two\nSelect", width = 10, height = 2, \
            font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2")  # command = self.lift_group_two_WINDOW)
        self.group_two_window_Button.bind("<Button-1>", self.lift_group_two_WINDOW)
        self.group_two_window_Button.grid(row=12, column=2)

        #
        # GROUP #2 WINDOW SIGNAL BUTTON. event_generate IF self.master indicates GROUP #2 WINDOW SELECTED.
        # 
        self.group_two_window_signal_label = Label(self.master, width = 10, height = 1, \
            font=('Helvetica', '8'), background="cyan4", fg="black", borderwidth=5, relief="raised")
        self.group_two_window_signal_label.grid(row=13, column=2)

        #
        # GROUP #3 WINDOW SELECT BUTTON. global USER_GUI_Config_Class_inst_LIST
        # 
        self.group_three_window_Button = Button(self.master, text = "Group Three\nSelect", width = 10, height = 2, \
            font=('Helvetica', '16'), background="cyan4", fg="black", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2")  # command = self.lift_group_three_WINDOW)
        self.group_three_window_Button.bind("<Button-1>", self.lift_group_three_WINDOW)
        self.group_three_window_Button.grid(row=12, column=3)

        #
        # GROUP #3 WINDOW SIGNAL BUTTON. event_generate IF self.master indicates GROUP #3 WINDOW SELECTED.
        # 
        self.group_three_window_signal_label = Label(self.master, width = 10, height = 1, \
            font=('Helvetica', '8'), background="cyan4", fg="black", borderwidth=5, relief="raised")
        self.group_three_window_signal_label.grid(row=13, column=3)
        ...
        if self.group_instance == "group_one_instance":
              self.medical_record_status_group_one = [
                    group1_frame1_status_text, group1_frame2_status_text, group1_frame3_status_text, group1_frame4_status_text, \
                    group1_frame5_status_text, group1_frame6_status_text, group1_frame7_status_text, group1_frame8_status_text, \
                    group1_frame9_status_text, group1_frame10_status_text, group1_frame11_status_text, group1_frame12_status_text
                    ]

        elif self.group_instance == "group_two_instance":
              self.medical_record_status_group_two = [
                    group2_frame1_status_text, group2_frame2_status_text, group2_frame3_status_text, group2_frame4_status_text, \
                    group2_frame5_status_text, group2_frame6_status_text, group2_frame7_status_text, group2_frame8_status_text, \
                    group2_frame9_status_text, group2_frame10_status_text, group2_frame11_status_text, group2_frame12_status_text
                    ]

        elif self.group_instance == "group_three_instance":
              self.medical_record_status_group_three = [
                    group3_frame1_status_text, group3_frame2_status_text, group3_frame3_status_text, group3_frame4_status_text, \
                    group3_frame5_status_text, group3_frame6_status_text, group3_frame7_status_text, group3_frame8_status_text, \
                    group3_frame9_status_text, group3_frame10_status_text, group3_frame11_status_text, group3_frame12_status_text
                    ]
    ...
    def load_medical_record_config_ini(self):
        ...
        if os.path.isfile(fullpath_med_config_ini_global) == True:
            ...
            user_gui_x_col_frames_value = med_startup_config.get("USER_DESIGNS_GUI", "user_gui_x_col_frames")
            user_gui_y_row_frames_value = med_startup_config.get("USER_DESIGNS_GUI", "user_gui_y_row_frames")
            ...
            user_gui_x_col_frames_value_global = str(user_gui_x_col_frames_value)
            user_gui_y_row_frames_value_global = str(user_gui_y_row_frames_value)
    ...
    def update_user_text_status(self, event):
        ...
        if "frame12" in str(event.widget.winfo_parent() ):
            ...
            if self.group_instance == "group_three_instance": group3_frame12_status_text = text_STATUS
            ...
            print("  ")
            print(".... self.group_instance = " + str(self.group_instance) + " .... STATUS: " + str(text_STATUS) )

            print("  ")
            print(".... group1_frame12_status_text = " + str(group1_frame12_status_text) )
            print(".... group2_frame12_status_text = " + str(group2_frame12_status_text) )
            print(".... group3_frame12_status_text = " + str(group3_frame12_status_text) )
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame11_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame10_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame9_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame8_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame7_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame6_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame5_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame4_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame3_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame2_status_text = text_STATUS
            ...
            # Determine GROUP then update corresponding status data global so we can build database med_rec_config.ini
            # that contains things like LABEL and STATUS Text in secure medical record database. 
            if self.group_instance == "group_three_instance": group3_frame1_status_text = text_STATUS
        ...
        if (os.path.isfile(fullpath_med_config_ini_global) == True) or (os.path.isfile(fullpath_med_config_ini_global) == False):
            ...
            #
            ###############################################################################################
            medical_config.set("USER_DESIGNS_GUI", "group1_frame1_user_label", "Insulin - mU/L (Fasting)")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame1_status_text", str(group1_frame1_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame1_user_button", "Record Insulin")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame2_user_label", "Insulin Resistance - mU/L (2 hrs)")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame2_status_text", str(group1_frame2_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame2_user_button", "Record Insulin Resistance")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame3_user_label", "Glucose - mg/dL (Fasting)")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame3_status_text", str(group1_frame3_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame3_user_button", "Record Glucose")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame4_user_label", "Glucose Response - mg/dL (2 hrs)")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame4_status_text", str(group1_frame4_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame4_user_button", "Record Glucose Response")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame5_user_label", "LDL-Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame5_status_text", str(group1_frame5_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame5_user_button", "Record LDL-Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame6_user_label", "Total Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame6_status_text", str(group1_frame6_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame6_user_button", "Record Total Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame7_user_label", "HDL-Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame7_status_text", str(group1_frame7_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame7_user_button", "Record HDL-Cholesterol")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame8_user_label", "Triglycerides")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame8_status_text", str(group1_frame8_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame8_user_button", "Record Triglycerides")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame9_user_label", "Body Weight")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame9_status_text", str(group1_frame9_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame9_user_button", "Record Body Weight")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame10_user_label", "Body Height")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame10_status_text", str(group1_frame10_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame10_user_button", "Record Body Height")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame11_user_label", "Resting Heart Rate")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame11_status_text", str(group1_frame11_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame11_user_button", "Record Resting Heart Rate")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame12_user_label", "Blood Press - (Sys/Dias) - mm Hg")
            medical_config.set("USER_DESIGNS_GUI", "group1_frame12_status_text", str(group1_frame12_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group1_frame12_user_button", "Record Blood Pressure")

            medical_config.set("USER_DESIGNS_GUI", "group2_frame1_user_label", "Serum Creatinine - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame1_status_text", str(group2_frame1_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame1_user_button", "Record Serum Creatinine")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame2_user_label", "Blood Urea Nitrogen - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame2_status_text", str(group2_frame2_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame2_user_button", "Record Blood Urea Nitrogen")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame3_user_label", "Serum Albumin - g/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame3_status_text", str(group2_frame3_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame3_user_button", "Record Serum Albumin")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame4_user_label", "Globulin - g/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame4_status_text", str(group2_frame4_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame4_user_button", "Record Globulin")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame5_user_label", "Urine Protein  - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame5_status_text", str(group2_frame5_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame5_user_button", "Record Urine Protein")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame6_user_label", "Total Bilirubin - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame6_status_text", str(group2_frame6_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame6_user_button", "Record Total Bilirubin")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame7_user_label", "Direct Bilirubin - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame7_status_text", str(group2_frame7_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame7_user_button", "Record Direct-Bilirubin")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame8_user_label", "AST - IU/L")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame8_status_text", str(group2_frame8_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame8_user_button", "Record AST")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame9_user_label", "ALT - IU/L")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame9_status_text", str(group2_frame9_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame9_user_button", "Record ALT")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame10_user_label", "GGT - IU/L")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame10_status_text", str(group2_frame10_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame10_user_button", "Record GGT")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame11_user_label", "ALP - U/L")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame11_status_text", str(group2_frame11_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame11_user_button", "Record ALP")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame12_user_label", "25(OH)D (Vitamin D3) - ng/ml")
            medical_config.set("USER_DESIGNS_GUI", "group2_frame12_status_text", str(group2_frame12_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group2_frame12_user_button", "Record 25(OH)D (Vitamin D3)")

            medical_config.set("USER_DESIGNS_GUI", "group3_frame1_user_label", "Sodium - mmol/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame1_status_text", str(group3_frame1_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame1_user_button", "Record Sodium")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame2_user_label", "Potasium - mmol/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame2_status_text", str(group3_frame2_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame2_user_button", "Record Potasium")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame3_user_label", "Chloride - mmol/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame3_status_text", str(group3_frame3_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame3_user_button", "Record Chloride")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame4_user_label", "Bicarbonate - mmol/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame4_status_text", str(group3_frame4_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame4_user_button", "Record Bicarbonate")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame5_user_label", "Calcium - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame5_status_text", str(group3_frame5_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame5_user_button", "Record Calcium")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame6_user_label", "Magnesium - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame6_status_text", str(group3_frame6_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame6_user_button", "Record Magnesium")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame7_user_label", "Phosphorus - mg/dL")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame7_status_text", str(group3_frame7_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame7_user_button", "Record Phosphorus")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame8_user_label", "Potassium - mmol/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame8_status_text", str(group3_frame8_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame8_user_button", "Record Potassium")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame9_user_label", "Troponins Test")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame9_status_text", str(group3_frame9_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame9_user_button", "Record Troponins")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame10_user_label", "NT-proBNP - pg/mL")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame10_status_text", str(group3_frame10_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame10_user_button", "Record NT-proBNP")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame11_user_label", "Myoglobin - mcg/L")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame11_status_text", str(group3_frame11_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame11_user_button", "Record Myoglobin")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame12_user_label", "CKMB - ng/mL")
            medical_config.set("USER_DESIGNS_GUI", "group3_frame12_status_text", str(group3_frame12_status_text) )
            medical_config.set("USER_DESIGNS_GUI", "group3_frame12_user_button", "Record CKMB")
             
            # save medical_record_config.ini file 
            with open(str(fullpath_med_config_ini_global), 'w') as configfile:
                 medical_config.write(configfile)
    ...
    def lift_group_one_WINDOW(self, event):
        ...
        ########################################################################################################################
        #
        # .... USER_GUI_Config_Class_group_one_inst = .!toplevel.!user_gui_config_class
        # .... USER_GUI_Config_Class_group_two_inst = .!toplevel2.!user_gui_config_class
        # .... USER_GUI_Config_Class_group_three_inst = .!toplevel3.!user_gui_config_class
        # 
        # .... USER_GUI_Config_Class_inst_LIST = [<__main__.USER_GUI_Config_Class object .!toplevel.!user_gui_config_class>,
        #                                         <__main__.USER_GUI_Config_Class object .!toplevel2.!user_gui_config_class>,
        #                                         <__main__.USER_GUI_Config_Class object .!toplevel3.!user_gui_config_class>]
        #  
        ########################################################################################################################
    ...
    def lift_group_three_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP THREE BUTTON - gui_group_three_object.lift() - " + str(gui_group_three_object) )
    ...
    def lower_this_WINDOW(self):
        self.master.lower()   # lowers the window.
...
class CM_App_Doc_Media(object):
    def __init__(self, master):
        ...
        self.master.title("Contact Management Application Software - EMAIL STARTUP Procedure.")
...
class Demo5(object):
    def __init__(self, master):
        ...
        self.master.title("Contact Management Application Software - EXPORT Contact List to Excel - IMPORT CSV to Contact List")
...
class Write_Exception_Logfile(object):
      ...
      def write_update_exception_logfile(self):
            with open(str(fullpath_exception_logfile_global), 'a') as exception_logfile:
                  ...
                  exception_logfile.write("\n_____________________________________________________________________________\n")
                  exception_logfile.write("\n" + ".... Contact  Management  Workstation  Enterprise  Cloud  Software  Application: *** Version 11.0 ***")
...
#################################################################################################
      ...
      if os.path.isfile(fullpath_app_config_ini_global) == False:
            ...
            config.add_section("USER_DESIGNS_GUI")
            config.set("USER_DESIGNS_GUI", "user_gui_title", "User Designs Screen Layout and Data Name")
            config.set("USER_DESIGNS_GUI", "user_gui_title_bg_color", "cyan4")
            config.set("USER_DESIGNS_GUI", "user_gui_title_fg_color", "light sea green")
            config.set("USER_DESIGNS_GUI", "user_gui_x_col_frames", "4")
            config.set("USER_DESIGNS_GUI", "user_gui_y_row_frames", "5")
            config.set("USER_DESIGNS_GUI", "user_gui_bg_color", "dark slate gray")
            config.set("USER_DESIGNS_GUI", "user_gui_fg_color", "snow")
            config.set("USER_DESIGNS_GUI", "user_gui_label_bg_color", "cyan4")
            config.set("USER_DESIGNS_GUI", "user_gui_label_fg_color", "cyan")
            config.set("USER_DESIGNS_GUI", "user_gui_entry_bg_color", "light sea green")
            config.set("USER_DESIGNS_GUI", "user_gui_entry_fg_color", "black")
            config.set("USER_DESIGNS_GUI", "user_gui_text_bg_color", "light sea green")
            config.set("USER_DESIGNS_GUI", "user_gui_text_fg_color", "black")
            ...
            #
            ###############################################################################################
            config.set("USER_DESIGNS_GUI", "group1_frame1_user_label", "Insulin - mU/L (Fasting)")
            config.set("USER_DESIGNS_GUI", "group1_frame1_status_text", "Enter Fasting Insulin Level below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame1_user_button", "Record Insulin")
            config.set("USER_DESIGNS_GUI", "group1_frame2_user_label", "Insulin Resistance - mU/L (2 hrs)")
            config.set("USER_DESIGNS_GUI", "group1_frame2_status_text", "Enter Insulin Resistance below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame2_user_button", "Record Insulin Resistance")
            config.set("USER_DESIGNS_GUI", "group1_frame3_user_label", "Glucose - mg/dL (Fasting)")
            config.set("USER_DESIGNS_GUI", "group1_frame3_status_text", "Enter Glucose Level below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame3_user_button", "Record Glucose")
            config.set("USER_DESIGNS_GUI", "group1_frame4_user_label", "Glucose Response - mg/dL (2 hrs)")
            config.set("USER_DESIGNS_GUI", "group1_frame4_status_text", "Enter Glucose Response below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame4_user_button", "Record Glucose Response")
            config.set("USER_DESIGNS_GUI", "group1_frame5_user_label", "LDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame5_status_text", "Enter LDL-Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame5_user_button", "Record LDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame6_user_label", "Total Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame6_status_text", "Enter Total Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame6_user_button", "Record Total Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame7_user_label", "HDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame7_status_text", "Enter HDL-Cholesterol below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame7_user_button", "Record HDL-Cholesterol")
            config.set("USER_DESIGNS_GUI", "group1_frame8_user_label", "Triglycerides")
            config.set("USER_DESIGNS_GUI", "group1_frame8_status_text", "Enter Triglycerides below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame8_user_button", "Record Triglycerides")
            config.set("USER_DESIGNS_GUI", "group1_frame9_user_label", "Body Weight")
            config.set("USER_DESIGNS_GUI", "group1_frame9_status_text", "Enter Body Weight below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame9_user_button", "Record Body Weight")
            config.set("USER_DESIGNS_GUI", "group1_frame10_user_label", "Body Height")
            config.set("USER_DESIGNS_GUI", "group1_frame10_status_text", "Enter Body Height below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame10_user_button", "Record Body Height")
            config.set("USER_DESIGNS_GUI", "group1_frame11_user_label", "Resting Heart Rate")
            config.set("USER_DESIGNS_GUI", "group1_frame11_status_text", "Enter Resting Heart Rate below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame11_user_button", "Record Resting Heart Rate")
            config.set("USER_DESIGNS_GUI", "group1_frame12_user_label", "Blood Press - (Sys/Dias) - mm Hg")
            config.set("USER_DESIGNS_GUI", "group1_frame12_status_text", "Enter Blood Pressure below ...")
            config.set("USER_DESIGNS_GUI", "group1_frame12_user_button", "Record Blood Pressure")

            config.set("USER_DESIGNS_GUI", "group2_frame1_user_label", "Serum Creatinine - mg/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame1_status_text", "Enter Serum Creatinine below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame1_user_button", "Record Serum Creatinine")
            config.set("USER_DESIGNS_GUI", "group2_frame2_user_label", "Blood Urea Nitrogen - mg/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame2_status_text", "Enter Blood Urea Nitrogen below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame2_user_button", "Record Blood Urea Nitrogen")
            config.set("USER_DESIGNS_GUI", "group2_frame3_user_label", "Serum Albumin - g/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame3_status_text", "Enter Serum Albumin Level below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame3_user_button", "Record Serum Albumin")
            config.set("USER_DESIGNS_GUI", "group2_frame4_user_label", "Globulin - g/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame4_status_text", "Enter Globulin Level below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame4_user_button", "Record Globulin")
            config.set("USER_DESIGNS_GUI", "group2_frame5_user_label", "Urine Protein  - mg/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame5_status_text", "Enter Urine Protein Level below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame5_user_button", "Record Urine Protein")
            config.set("USER_DESIGNS_GUI", "group2_frame6_user_label", "Total Bilirubin - mg/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame6_status_text", "Enter Total Bilirubin below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame6_user_button", "Record Total Bilirubin")
            config.set("USER_DESIGNS_GUI", "group2_frame7_user_label", "Direct Bilirubin - mg/dL")
            config.set("USER_DESIGNS_GUI", "group2_frame7_status_text", "Enter Direct-Bilirubin below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame7_user_button", "Record Direct-Bilirubin")
            config.set("USER_DESIGNS_GUI", "group2_frame8_user_label", "AST - IU/L")
            config.set("USER_DESIGNS_GUI", "group2_frame8_status_text", "Enter AST below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame8_user_button", "Record AST")
            config.set("USER_DESIGNS_GUI", "group2_frame9_user_label", "ALT - IU/L")
            config.set("USER_DESIGNS_GUI", "group2_frame9_status_text", "Enter ALT below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame9_user_button", "Record ALT")
            config.set("USER_DESIGNS_GUI", "group2_frame10_user_label", "GGT - IU/L")
            config.set("USER_DESIGNS_GUI", "group2_frame10_status_text", "Enter GGT Level below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame10_user_button", "Record GGT")
            config.set("USER_DESIGNS_GUI", "group2_frame11_user_label", "ALP - U/L")
            config.set("USER_DESIGNS_GUI", "group2_frame11_status_text", "Enter ALP Level below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame11_user_button", "Record ALP")
            config.set("USER_DESIGNS_GUI", "group2_frame12_user_label", "25(OH)D (Vitamin D3) - ng/ml")
            config.set("USER_DESIGNS_GUI", "group2_frame12_status_text", "Enter 25(OH)D (Vitamin D3) below ...")
            config.set("USER_DESIGNS_GUI", "group2_frame12_user_button", "Record 25(OH)D (Vitamin D3)")

            config.set("USER_DESIGNS_GUI", "group3_frame1_user_label", "Sodium - mmol/L")
            config.set("USER_DESIGNS_GUI", "group3_frame1_status_text", "Enter Sodium Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame1_user_button", "Record Sodium")
            config.set("USER_DESIGNS_GUI", "group3_frame2_user_label", "Potasium - mmol/L")
            config.set("USER_DESIGNS_GUI", "group3_frame2_status_text", "Enter Potasium Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame2_user_button", "Record Potasium")
            config.set("USER_DESIGNS_GUI", "group3_frame3_user_label", "Chloride - mmol/L")
            config.set("USER_DESIGNS_GUI", "group3_frame3_status_text", "Enter Chloride Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame3_user_button", "Record Chloride")
            config.set("USER_DESIGNS_GUI", "group3_frame4_user_label", "Bicarbonate - mmol/L")
            config.set("USER_DESIGNS_GUI", "group3_frame4_status_text", "Enter Bicarbonate Levels below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame4_user_button", "Record Bicarbonate")
            config.set("USER_DESIGNS_GUI", "group3_frame5_user_label", "Calcium - mg/dL")
            config.set("USER_DESIGNS_GUI", "group3_frame5_status_text", "Enter Calium Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame5_user_button", "Record Calcium")
            config.set("USER_DESIGNS_GUI", "group3_frame6_user_label", "Magnesium - mg/dL")
            config.set("USER_DESIGNS_GUI", "group3_frame6_status_text", "Enter Magnesium Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame6_user_button", "Record Magnesium")
            config.set("USER_DESIGNS_GUI", "group3_frame7_user_label", "Phosphorus - mg/dL")
            config.set("USER_DESIGNS_GUI", "group3_frame7_status_text", "Enter Phosphorus Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame7_user_button", "Record Phosphorus")
            config.set("USER_DESIGNS_GUI", "group3_frame8_user_label", "Potassium - mmol/L")
            config.set("USER_DESIGNS_GUI", "group3_frame8_status_text", "Enter Potassium Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame8_user_button", "Record Potassium")
            config.set("USER_DESIGNS_GUI", "group3_frame9_user_label", "Troponins Test")
            config.set("USER_DESIGNS_GUI", "group3_frame9_status_text", "Enter Troponins Results below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame9_user_button", "Record Troponins")
            config.set("USER_DESIGNS_GUI", "group3_frame10_user_label", "NT-proBNP - pg/mL")
            config.set("USER_DESIGNS_GUI", "group3_frame10_status_text", "Enter NT-proBNP Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame10_user_button", "Record NT-proBNP")
            config.set("USER_DESIGNS_GUI", "group3_frame11_user_label", "Myoglobin - mcg/L")
            config.set("USER_DESIGNS_GUI", "group3_frame11_status_text", "Enter Myoglobin Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame11_user_button", "Record Myoglobin")
            config.set("USER_DESIGNS_GUI", "group3_frame12_user_label", "CKMB - ng/mL")
            config.set("USER_DESIGNS_GUI", "group3_frame12_status_text", "Enter CKMB Level below ...")
            config.set("USER_DESIGNS_GUI", "group3_frame12_user_button", "Record CKMB")
...
#################################################################################################
            ...
            # USER_GUI_CONFIG Class - WIDGET Configuration - 3 Windows (Data Groups) of 
            #
            # 12 WIDGET Frames Widget Configuration (Global) Variables written to app_config.ini
            #
            #####################################################################################

            # read values from app_config.ini file sections
            user_gui_title_value = config.get("USER_DESIGNS_GUI", "user_gui_title")
            user_gui_title_bg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_title_bg_color")
            user_gui_title_fg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_title_fg_color")
            user_gui_x_col_frames_value = config.get("USER_DESIGNS_GUI", "user_gui_x_col_frames")
            user_gui_y_row_frames_value = config.get("USER_DESIGNS_GUI", "user_gui_y_row_frames")
            user_gui_bg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_bg_color")
            user_gui_fg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_fg_color")
            user_gui_label_bg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_label_bg_color")
            user_gui_label_fg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_label_fg_color")
            user_gui_entry_bg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_entry_bg_color")
            user_gui_entry_fg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_entry_fg_color")
            user_gui_text_bg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_text_bg_color")
            user_gui_text_fg_color_value = config.get("USER_DESIGNS_GUI", "user_gui_text_fg_color")
            ...
            # read GROUP #1 values from app_config.ini file sections 
            group1_frame1_user_label = config.get("USER_DESIGNS_GUI", "group1_frame1_user_label")
            group1_frame1_status_text = config.get("USER_DESIGNS_GUI", "group1_frame1_status_text")
            group1_frame1_user_button = config.get("USER_DESIGNS_GUI", "group1_frame1_user_button")
            group1_frame2_user_label = config.get("USER_DESIGNS_GUI", "group1_frame2_user_label")
            group1_frame2_status_text = config.get("USER_DESIGNS_GUI", "group1_frame2_status_text")
            group1_frame2_user_button = config.get("USER_DESIGNS_GUI", "group1_frame2_user_button")
            group1_frame3_user_label = config.get("USER_DESIGNS_GUI", "group1_frame3_user_label")
            group1_frame3_status_text = config.get("USER_DESIGNS_GUI", "group1_frame3_status_text")
            group1_frame3_user_button = config.get("USER_DESIGNS_GUI", "group1_frame3_user_button")
            group1_frame4_user_label = config.get("USER_DESIGNS_GUI", "group1_frame4_user_label")
            group1_frame4_status_text = config.get("USER_DESIGNS_GUI", "group1_frame4_status_text")
            group1_frame4_user_button = config.get("USER_DESIGNS_GUI", "group1_frame4_user_button")
            group1_frame5_user_label = config.get("USER_DESIGNS_GUI", "group1_frame5_user_label")
            group1_frame5_status_text = config.get("USER_DESIGNS_GUI", "group1_frame5_status_text")
            group1_frame5_user_button = config.get("USER_DESIGNS_GUI", "group1_frame5_user_button")
            group1_frame6_user_label = config.get("USER_DESIGNS_GUI", "group1_frame6_user_label")
            group1_frame6_status_text = config.get("USER_DESIGNS_GUI", "group1_frame6_status_text")
            group1_frame6_user_button = config.get("USER_DESIGNS_GUI", "group1_frame6_user_button")
            group1_frame7_user_label = config.get("USER_DESIGNS_GUI", "group1_frame7_user_label")
            group1_frame7_status_text = config.get("USER_DESIGNS_GUI", "group1_frame7_status_text")
            group1_frame7_user_button = config.get("USER_DESIGNS_GUI", "group1_frame7_user_button")
            group1_frame8_user_label = config.get("USER_DESIGNS_GUI", "group1_frame8_user_label")
            group1_frame8_status_text = config.get("USER_DESIGNS_GUI", "group1_frame8_status_text")
            group1_frame8_user_button = config.get("USER_DESIGNS_GUI", "group1_frame8_user_button")
            group1_frame9_user_label = config.get("USER_DESIGNS_GUI", "group1_frame9_user_label")
            group1_frame9_status_text = config.get("USER_DESIGNS_GUI", "group1_frame9_status_text")
            group1_frame9_user_button = config.get("USER_DESIGNS_GUI", "group1_frame9_user_button")
            group1_frame10_user_label = config.get("USER_DESIGNS_GUI", "group1_frame10_user_label")
            group1_frame10_status_text = config.get("USER_DESIGNS_GUI", "group1_frame10_status_text")
            group1_frame10_user_button = config.get("USER_DESIGNS_GUI", "group1_frame10_user_button")
            group1_frame11_user_label = config.get("USER_DESIGNS_GUI", "group1_frame11_user_label")
            group1_frame11_status_text = config.get("USER_DESIGNS_GUI", "group1_frame11_status_text")
            group1_frame11_user_button = config.get("USER_DESIGNS_GUI", "group1_frame11_user_button")
            group1_frame12_user_label = config.get("USER_DESIGNS_GUI", "group1_frame12_user_label")
            group1_frame12_status_text = config.get("USER_DESIGNS_GUI", "group1_frame12_status_text")
            group1_frame12_user_button = config.get("USER_DESIGNS_GUI", "group1_frame12_user_button")

            # read GROUP #2 values from app_config.ini file sections  
            group2_frame1_user_label = config.get("USER_DESIGNS_GUI", "group2_frame1_user_label")
            group2_frame1_status_text = config.get("USER_DESIGNS_GUI", "group2_frame1_status_text")
            group2_frame1_user_button = config.get("USER_DESIGNS_GUI", "group2_frame1_user_button")
            group2_frame2_user_label = config.get("USER_DESIGNS_GUI", "group2_frame2_user_label")
            group2_frame2_status_text = config.get("USER_DESIGNS_GUI", "group2_frame2_status_text")
            group2_frame2_user_button = config.get("USER_DESIGNS_GUI", "group2_frame2_user_button")
            group2_frame3_user_label = config.get("USER_DESIGNS_GUI", "group2_frame3_user_label")
            group2_frame3_status_text = config.get("USER_DESIGNS_GUI", "group2_frame3_status_text")
            group2_frame3_user_button = config.get("USER_DESIGNS_GUI", "group2_frame3_user_button")
            group2_frame4_user_label = config.get("USER_DESIGNS_GUI", "group2_frame4_user_label")
            group2_frame4_status_text = config.get("USER_DESIGNS_GUI", "group2_frame4_status_text")
            group2_frame4_user_button = config.get("USER_DESIGNS_GUI", "group2_frame4_user_button")
            group2_frame5_user_label = config.get("USER_DESIGNS_GUI", "group2_frame5_user_label")
            group2_frame5_status_text = config.get("USER_DESIGNS_GUI", "group2_frame5_status_text")
            group2_frame5_user_button = config.get("USER_DESIGNS_GUI", "group2_frame5_user_button")
            group2_frame6_user_label = config.get("USER_DESIGNS_GUI", "group2_frame6_user_label")
            group2_frame6_status_text = config.get("USER_DESIGNS_GUI", "group2_frame6_status_text")
            group2_frame6_user_button = config.get("USER_DESIGNS_GUI", "group2_frame6_user_button")
            group2_frame7_user_label = config.get("USER_DESIGNS_GUI", "group2_frame7_user_label")
            group2_frame7_status_text = config.get("USER_DESIGNS_GUI", "group2_frame7_status_text")
            group2_frame7_user_button = config.get("USER_DESIGNS_GUI", "group2_frame7_user_button")
            group2_frame8_user_label = config.get("USER_DESIGNS_GUI", "group2_frame8_user_label")
            group2_frame8_status_text = config.get("USER_DESIGNS_GUI", "group2_frame8_status_text")
            group2_frame8_user_button = config.get("USER_DESIGNS_GUI", "group2_frame8_user_button")
            group2_frame9_user_label = config.get("USER_DESIGNS_GUI", "group2_frame9_user_label")
            group2_frame9_status_text = config.get("USER_DESIGNS_GUI", "group2_frame9_status_text")
            group2_frame9_user_button = config.get("USER_DESIGNS_GUI", "group2_frame9_user_button")
            group2_frame10_user_label = config.get("USER_DESIGNS_GUI", "group2_frame10_user_label")
            group2_frame10_status_text = config.get("USER_DESIGNS_GUI", "group2_frame10_status_text")
            group2_frame10_user_button = config.get("USER_DESIGNS_GUI", "group2_frame10_user_button")
            group2_frame11_user_label = config.get("USER_DESIGNS_GUI", "group2_frame11_user_label")
            group2_frame11_status_text = config.get("USER_DESIGNS_GUI", "group2_frame11_status_text")
            group2_frame11_user_button = config.get("USER_DESIGNS_GUI", "group2_frame11_user_button")
            group2_frame12_user_label = config.get("USER_DESIGNS_GUI", "group2_frame12_user_label")
            group2_frame12_status_text = config.get("USER_DESIGNS_GUI", "group2_frame12_status_text")
            group2_frame12_user_button = config.get("USER_DESIGNS_GUI", "group2_frame12_user_button")

            # read GROUP #3 values from app_config.ini file sections  
            group3_frame1_user_label = config.get("USER_DESIGNS_GUI", "group3_frame1_user_label")
            group3_frame1_status_text = config.get("USER_DESIGNS_GUI", "group3_frame1_status_text")
            group3_frame1_user_button = config.get("USER_DESIGNS_GUI", "group3_frame1_user_button")
            group3_frame2_user_label = config.get("USER_DESIGNS_GUI", "group3_frame2_user_label")
            group3_frame2_status_text = config.get("USER_DESIGNS_GUI", "group3_frame2_status_text")
            group3_frame2_user_button = config.get("USER_DESIGNS_GUI", "group3_frame2_user_button")
            group3_frame3_user_label = config.get("USER_DESIGNS_GUI", "group3_frame3_user_label")
            group3_frame3_status_text = config.get("USER_DESIGNS_GUI", "group3_frame3_status_text")
            group3_frame3_user_button = config.get("USER_DESIGNS_GUI", "group3_frame3_user_button")
            group3_frame4_user_label = config.get("USER_DESIGNS_GUI", "group3_frame4_user_label")
            group3_frame4_status_text = config.get("USER_DESIGNS_GUI", "group3_frame4_status_text")
            group3_frame4_user_button = config.get("USER_DESIGNS_GUI", "group3_frame4_user_button")
            group3_frame5_user_label = config.get("USER_DESIGNS_GUI", "group3_frame5_user_label")
            group3_frame5_status_text = config.get("USER_DESIGNS_GUI", "group3_frame5_status_text")
            group3_frame5_user_button = config.get("USER_DESIGNS_GUI", "group3_frame5_user_button")
            group3_frame6_user_label = config.get("USER_DESIGNS_GUI", "group3_frame6_user_label")
            group3_frame6_status_text = config.get("USER_DESIGNS_GUI", "group3_frame6_status_text")
            group3_frame6_user_button = config.get("USER_DESIGNS_GUI", "group3_frame6_user_button")
            group3_frame7_user_label = config.get("USER_DESIGNS_GUI", "group3_frame7_user_label")
            group3_frame7_status_text = config.get("USER_DESIGNS_GUI", "group3_frame7_status_text")
            group3_frame7_user_button = config.get("USER_DESIGNS_GUI", "group3_frame7_user_button")
            group3_frame8_user_label = config.get("USER_DESIGNS_GUI", "group3_frame8_user_label")
            group3_frame8_status_text = config.get("USER_DESIGNS_GUI", "group3_frame8_status_text")
            group3_frame8_user_button = config.get("USER_DESIGNS_GUI", "group3_frame8_user_button")
            group3_frame9_user_label = config.get("USER_DESIGNS_GUI", "group3_frame9_user_label")
            group3_frame9_status_text = config.get("USER_DESIGNS_GUI", "group3_frame9_status_text")
            group3_frame9_user_button = config.get("USER_DESIGNS_GUI", "group3_frame9_user_button")
            group3_frame10_user_label = config.get("USER_DESIGNS_GUI", "group3_frame10_user_label")
            group3_frame10_status_text = config.get("USER_DESIGNS_GUI", "group3_frame10_status_text")
            group3_frame10_user_button = config.get("USER_DESIGNS_GUI", "group3_frame10_user_button")
            group3_frame11_user_label = config.get("USER_DESIGNS_GUI", "group3_frame11_user_label")
            group3_frame11_status_text = config.get("USER_DESIGNS_GUI", "group3_frame11_status_text")
            group3_frame11_user_button = config.get("USER_DESIGNS_GUI", "group3_frame11_user_button")
            group3_frame12_user_label = config.get("USER_DESIGNS_GUI", "group3_frame12_user_label")
            group3_frame12_status_text = config.get("USER_DESIGNS_GUI", "group3_frame12_status_text")
            group3_frame12_user_button = config.get("USER_DESIGNS_GUI", "group3_frame12_user_button")
...
#123456789012345678901
                     try:
                         ...
                         first_and_last_name = "Contact: " + str(fn_browse) + " " + str(ln_browse)
                         ...
                         # inspect_var_or_dict = inspect.getmembers(MyClass.my_method.__func__.__code__)   
                         # inspect_getmembers_App = dict(inspect.getmembers(App))  
                         # inspect_getmembers_Email_Gmail_Class = dict(inspect.getmembers(Email_Gmail_Class))
                         # pprint.pprint(".... inspect_getmembers_App = " + str(inspect_getmembers_App) )
                         # pprint.pprint("....")
                         # pprint.pprint("....")
                         # pprint.pprint("....")
                         # pprint.pprint(".... inspect_getmembers_Email_Gmail_Class = " + str(inspect_getmembers_Email_Gmail_Class) )
