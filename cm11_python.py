...
###########################################################################################################
      ...
      def user_defined_gui_window(self):
            self.user_defined_gui_WINDOW = tk.Toplevel(self.master)
            self.user_defined_gui = USER_GUI_Config_Class(self.user_defined_gui_WINDOW)
            return
...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        Frame.__init__(self, master)
        self.grid()
        self.master.title("Contact Management Application Software - User-Defined Graphical User Interface:   U S E R - D E F I N E D   G U I .")
        #self.master = master
        #self.frame = tk.Frame(self.master)
        ...
        print(".... user_gui_bg_color_value_global = " + str(user_gui_bg_color_value_global) )
        print(".... user_gui_x_col_frames_value_global = " + str(user_gui_x_col_frames_value_global) )
        print(".... user_gui_y_row_frames_value_global = " + str(user_gui_y_row_frames_value_global) )

        num_x_col_frames = int(user_gui_x_col_frames_value_global)
        num_y_row_frames = int(user_gui_y_row_frames_value_global)

        print(".... num_x_col_frames = " + str(num_x_col_frames) )
        print(".... num_y_row_frames = " + str(num_y_row_frames) )
        ...
        for item in self.entry_instances:
            ...
            # print(".... self.entry_instances LIST ITEM = " + str(item) )
