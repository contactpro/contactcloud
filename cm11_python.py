...
class USER_GUI_Config_Class(Frame):    #(object)
    ...
    def lower_this_WINDOW(self):
        ...
        elif (OBJECT_toplevel_user_gui_1_config_class.winfo_exists() ) == True:
            OBJECT_toplevel_user_gui_config_class.lift()

        elif (OBJECT_toplevel_user_gui_2_config_class.winfo_exists() ) == True:
            OBJECT_toplevel_user_gui_config_class.lift()

        elif (OBJECT_toplevel_user_gui_3_config_class.winfo_exists() ) == True:
            OBJECT_toplevel_user_gui_config_class.lift()
