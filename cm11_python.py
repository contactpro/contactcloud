            ...
            for c in scroll_label:
                  if r > 2 and r < 9:
                       if r == 3:
                             ...
                             speedbutton_5 = Button(self.master, text = "USER GUI", \
                             width=12,height=2, font=medium_font, \
...
#
#   This USER_GUI_Config_Class allows USERS to configure and tkinter GUI template
#   consisting of: 
#
#   1. Frames
#   2. Label Widgets
...
class USER_GUI_Config_Class(Frame):    #(object)
    def __init__(self, master):
        ...
        Frame.__init__(self, master)
        self.grid()
        self.master.title("Contact Management Application Software - User-Defined Graphical User Interface:   U S E R   G U I .")
        #self.master = master
        #self.frame = tk.Frame(self.master)
        ...
        self.user_label_text_1 = "User Label Text 1"
        self.user_label_one = Label(self.Frame1, text = self.user_label_text_1, font=('Helvetica', '12') )
        self.user_label_one.config(height = 1, width=26, anchor = W)
        self.user_label_one.config(bg='cyan4', fg="cyan")  
        self.user_label_one.grid(row=0, column=0, padx=5, pady=5)

        self.user_entry_stringvar_1 = StringVar()
        self.user_entry_one = Entry(self.Frame1, textvariable = self.user_entry_stringvar_1, font=('Helvetica', '12'), width = 26)
        self.user_entry_one.grid(sticky = W, row=1, column=0, padx=5, pady=5)
        self.user_entry_one.config(borderwidth=5, background="light sea green", fg ="black")

        self.user_text_one = Text(self.Frame1, width=26, height = 1)
        self.user_text_one.grid(row=2, column=0, padx=5, pady=5, sticky = W)
        self.user_text_one.config(borderwidth=5, font=('Helvetica', '12'), background="light sea green", fg ="black")
        text_1_STATUS = "  Status Text #1"
        self.user_text_one.insert(END, text_1_STATUS)

        self.user_button_one = Button(self.Frame1, text = "User Button #1", width = 26, height = 1, \
            font=('Helvetica', '12'), background="cyan4", fg="cyan", borderwidth=5,\
            activebackground="cyan",activeforeground="blue2", command = self.update_user_text_one_status)

        self.user_button_one.grid(row=3, column=0, padx=5, pady=5, sticky = W)
    ...
    def update_user_text_one_status(self):
        entry_text_data = self.user_entry_stringvar_1.get()
        self.user_text_one.delete(1.0, END)  # Clear the TEXT WIDGET of old Status Data   
        text_1_STATUS = "  Status Update: " + str(entry_text_data)
        self.user_text_one.insert(END, text_1_STATUS)
