...
# script called "CM-4.0-amd64.msi"
#
...
# application is named CM-4.0-amd64.msi and is located in the /dist folder
# below where you just ran the setup.py script.
#
# STEP #5:
#
# Copy the MSI installer, CM-4.0-amd64.msi, to a new Folder named something like
# C:/...... /CM_MSI_INSTALLER_SAVE/ and then double click on the CM-4.0-amd64.msi
...
setup(name='CM',
      version='4.0',
      description='cx_Freeze Tkinter script for contact_management_python.py - v4 - 64Bit',
