...
# script called "CM-8.0-amd64.msi"
#
...
# application is named CM-8.0-amd64.msi and is located in the /dist folder
# below where you just ran the setup.py script.
#
# STEP #5:
#
# Copy the MSI installer, CM-8.0-amd64.msi, to a new Folder named something like
# C:/...... /CM_MSI_INSTALLER_VERSION_8/ and then double click on the CM-7.0-amd64.msi
...
#
# c:/Users/chipcoder4972/Desktop/Documents/PYTHON_3_CODE/PYTHON_3_FREEZE/work_eight/build/exe.win-amd64-3.6/lib/numpy/core/_methods.py
#
...
# to this path after BUILD:
#
# c:\Users\chipcoder4972\Desktop\Documents\PYTHON_3_CODE\PYTHON_3_FREEZE\work_eight\build\exe.win-amd64-3.6\lib\numpy\core\_methods.py
#
#############################################################################################
#
# I solve it by
...
setup(name='CM',
      version='8.0',
      description='cx_Freeze Tkinter script for contact_management_python.py - v8 - 64Bit',
