...
# script called "CM-14.1-amd64.msi"
#
...
# application is named CM-14.1-amd64.msi and is located in the /dist folder
# below where you just ran the setup.py script.
#
# STEP #5:
#
# Copy the MSI installer, CM-14.1-amd64.msi, to a new Folder named something like
# C:/...... /CM_MSI_INSTALLER_VERSION_14/ and then double click on the CM-14.1-amd64.msi
...
setup(name='CM',
      version='14.1',
      description='cx_Freeze Tkinter script for contact_management_python.py - version 14.1 - 64Bit',
