...
fullpath_prepend_cnotes_dict_file_global = "FULLPATH_PREPEND_CNOTES_DICT_FILE Not Set"
...
class Demo3(object):
    ...
    def get_Textbox_File (self, event):
        ...
        prepend_cnotes_dict_file_global = "prepend_cnotes_" + str(cm_textbox_newfile_global) + ".txt"
        ...
        # Open the File for Contact NOTES DICTIONARY Filename cnotes_dict_file_global
