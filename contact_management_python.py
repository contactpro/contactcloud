...
###########################################################################################
        ...
        self.select_file_button = Button(self.master, text = "C L I C K   H E R E\nto Save All Settings.", width=16,height=2, font=('Helvetica', '18'), background="light sea green")

        self.select_file_button.grid(row=0, column=0, sticky = NW)
        self.select_file_button.bind("<Button-1>", self.get_Config_Textbox_Settings)
        

        self.select_listbox_color_button = Button(self.Frame4, text = "CLICK HERE after you \nhave SELECTED \na COLOR from LISTBOX", \
            width=25,height=3, font=('Helvetica', '12'), background="light sea green")

        # removed command = self.get_Listbox_File to resolve the this: 
        # TypeError: get_Listbox_File() missing 1 required positional argument: 'event'
            
        self.select_listbox_color_button.grid(row=0, column=3, sticky = N)
        self.select_listbox_color_button.bind("<Button-1>", self.get_Listbox_File)


        self.show_instructions1_button = Button(self.master, text = "\nBackground", width=15,height=2, font=('Helvetica', '18'), background="ivory4")
            
        self.show_instructions1_button.grid(row=0, column=1, sticky = NW)

        self.show_instructions2_button = Button(self.master, text = "\nForeground", width=15,height=2, font=('Helvetica', '18'), background="ivory4")
...
############################################################################################### 
        ...
        List_of_Colors_Background = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
        ...
        List_of_Colors_Foreground = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
            'linen', 'antique white', 'papaya whip', 'blanched almond', 'bisque', 'peach puff',
            'navajo white', 'lemon chiffon', 'mint cream', 'azure', 'alice blue', 'lavender',
            'lavender blush', 'misty rose', 'dark slate gray', 'dim gray', 'slate gray',
            'light slate gray', 'gray', 'light grey', 'midnight blue', 'navy', 'cornflower blue', 'dark slate blue',
        ...
        self.main_optionsmenu_inst.grid(sticky = NW, row=1, column=1)
        self.main_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_main = self.main_optionsmenu_inst.nametowidget(self.main_optionsmenu_inst.menuname) 
        menu_main.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        self.view_optionsmenu_inst.grid(sticky = NW, row=2, column=1)
        self.view_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_view = self.view_optionsmenu_inst.nametowidget(self.view_optionsmenu_inst.menuname) 
        menu_view.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        self.select_optionsmenu_inst.grid(sticky = NW, row=3, column=1)
        self.select_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_select = self.select_optionsmenu_inst.nametowidget(self.select_optionsmenu_inst.menuname) 
        menu_select.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        self.newlist_optionsmenu_inst.grid(sticky = NW, row=4, column=1)
        self.newlist_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_newlist = self.newlist_optionsmenu_inst.nametowidget(self.newlist_optionsmenu_inst.menuname) 
        menu_newlist.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        self.usermanual_optionsmenu_inst.grid(sticky = NW, row=5, column=1)
        self.usermanual_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_usermanual = self.usermanual_optionsmenu_inst.nametowidget(self.usermanual_optionsmenu_inst.menuname) 
        menu_usermanual.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        self.config_optionsmenu_inst.grid(sticky = NW, row=6, column=1)
        self.config_optionsmenu_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_config = self.config_optionsmenu_inst.nametowidget(self.config_optionsmenu_inst.menuname) 
        menu_config.configure(font=("Helvetica", 16), bg="light sea green") 
...
#######################################################################################################
        ...
        *List_of_Colors_Foreground, command=self.func_set_main_fg_global)
        self.main_optionsmenu_fg_inst.grid(sticky = NW, row=1, column=2)
        self.main_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_main_fg = self.main_optionsmenu_fg_inst.nametowidget(self.main_optionsmenu_fg_inst.menuname) 
        menu_main_fg.configure(font=("Helvetica", 16), bg="light sea green") 
        ...
        *List_of_Colors_Foreground, command=self.func_set_view_fg_global)
        self.view_optionsmenu_fg_inst.grid(sticky = NW, row=2, column=2)
        self.view_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_view_fg = self.view_optionsmenu_fg_inst.nametowidget(self.view_optionsmenu_fg_inst.menuname) 
        menu_view_fg.configure(font=("Helvetica", 16), bg="light sea green")
        ...
        self.select_optionsmenu_fg_inst.grid(sticky = NW, row=3, column=2)
        self.select_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_select_fg = self.select_optionsmenu_fg_inst.nametowidget(self.select_optionsmenu_fg_inst.menuname) 
        menu_select_fg.configure(font=("Helvetica", 16), bg="light sea green")
        ...
        self.newlist_optionsmenu_fg_inst.grid(sticky = NW, row=4, column=2)
        self.newlist_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_newlist_fg = self.newlist_optionsmenu_fg_inst.nametowidget(self.newlist_optionsmenu_fg_inst.menuname) 
        menu_newlist_fg.configure(font=("Helvetica", 16), bg="light sea green")
        ...
        self.usermanual_optionsmenu_fg_inst.grid(sticky = NW, row=5, column=2)
        self.usermanual_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_usermanual_fg = self.usermanual_optionsmenu_fg_inst.nametowidget(self.usermanual_optionsmenu_fg_inst.menuname) 
        menu_usermanual_fg.configure(font=("Helvetica", 16), bg="light sea green")
        ...
        self.config_optionsmenu_fg_inst.grid(sticky = NW, row=6, column=2)
        self.config_optionsmenu_fg_inst.config(borderwidth=5, background="light sea green", font=('Helvetica', 16 ) )

        menu_config_fg = self.config_optionsmenu_fg_inst.nametowidget(self.config_optionsmenu_fg_inst.menuname) 
        menu_config_fg.configure(font=("Helvetica", 16), bg="light sea green")
    ...
    def get_Listbox_File(self, event):
        global listbox_color_value_global
        # This button command gets the listbox_color_value_global
        # from the OnListBoxSelect(self, event)
        #     
        ...
        # if the USER (OPERATOR) does NOT select a COLOR from the LISTBOX.
        # If the USER (OPERATOR) does NOT select a COLOR from the LISTBOX,
        # we notify the operator with a messagebox. 

        verify_listbox_selection = self.lbox.curselection()

        try:
               test_listbox_color_value = str(self.lbox.get(verify_listbox_selection[0] ) )
        except IndexError as err:
               messagebox.showinfo("Contact Manager Guide ...", \
               "ATTENTION: \n\nPlease SELECT a COLOR from the LISTBOX ..... \n\n OPERATOR ERROR (Index Error): \n" + str(err) )
               self.master.destroy()
               return


        selection = self.lbox.curselection()
        listbox_color_value = self.lbox.get(selection[0])
        listbox_color_value_global = self.lbox.get(selection[0])
        
        # Change the COLOR in the Text Widget for the Viewer
        self.seeColors.config(background=str(listbox_color_value_global) )

        # store_selected listbox filename - cm_filename_value in two classes
        listbox_color_instance = Store_Lbox_Filename(selected_lbox_file = listbox_color_value)
        listbox_color_instance.set_listbox_file(new_Lbox_File = listbox_color_value)
        get_lb_color_call = listbox_color_instance.get_listbox_file()

        # WE ARE SELECTING A COLOR, BUT WE ALSO MAY WANT TO
        # SORT THE COLORS IN THE FUTURE ...... 
        listbox_color_string = str(listbox_color_value_global)
        ...
        # Return the listbox_color_value
        # Note that we also set an identical Global: listbox_color_value_global
