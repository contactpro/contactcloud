...
#
# Description: Contact Management Command Center Workstation Application Software
#
...
class App(Frame):    #( object)
      ...
      def __init__(self, master):
            ...
            self.master.title("Contact Management COMMAND CENTER WORKSTATION Application Software")
            ...
            self.excel_import_export_button = Button(self.master, text = "Import / Export\nE x c e l", \
                width=12,height=2, background="dark slate gray", fg = "light sea green", command = self.export_CSV_for_Excel_method)
            ...
            *List_of_Program_Modes, command=self.func_set_mode_select_global)
            ...
            self.sort_contact_list_button = Button(self.master, text = "SORT Contacts", \
                  width=15,height=1, font=('Helvetica', '12'), background="cyan4", fg="black", \
            ...
            for c in scroll_label:
                  if r > 2 and r < 9:
                       if r == 3:
                             ...
                             speedbutton_5 = Button(self.master, text = "MEDICAL\nRECORD", \
                             ...
                             width=12,height=2, font=medium_font, \
                             background="dark slate gray", fg = "light sea green", command = self.insert_Data_Entry)
...
###################################################################################### 
            ...
            self.app_status_display_select_button = Button(self.master, \
                text = "APP STATUS", width=14, height=1, command = self.select_App_Status_Display_method)
...
###########################################################################################################
      ...
      ######################################################################################
      #   
      # crm_startup_screen_show_method to cycle through a SET OF SCREENS to quickly show 
      # the USER the Customer Relationship Management (CRM) Screen Views.
      #        
      ######################################################################################
      #
      def crm_startup_screen_show_method(self):  
          ...
          self.after(4000, lambda: self.new_list_window_method() )

          self.after(8000, lambda: self.new_window_method() )

          self.after(12000, lambda: self.view_mode_method() )

          self.after(16000, lambda: self.export_CSV_for_Excel_method() )

          self.after(20000, lambda: self.build_list_from_dual_listbox_window_method() )

          self.after(24000, lambda: self.cm_app_doc_media_window_method() )

          self.after(28000, lambda: self.email_Gmail_Feature_method() )

          self.after(32000, lambda: self.select_App_Status_Display_method() )

          self.after(36000, lambda: self.config_App_Settings_method() )

          self.after(40000, lambda: OBJECT_main.lift() )

          self.after(40100, lambda: self.COMMAND_CENTER_STARTUP_method() )


          
      def display_messagebox_CYCLE_SCREENS(self):

          self.system_administration_View_method()
            
          messagebox.showinfo("Contact Manager Guide ... CRM STARTUP INTRODUCTION ....", \
                              "WELCOME to the CRM STARTUP INTRODUCTION: \n\nWelcome to the (ONE-MINUTE-OR-LESS) \nCRM STARTUP INTRODUCTION.\n\nWe are going to quickly introduce you to \nseveral CONTACT MANAGEMENT Screens.\n\nEach SCREEN VIEW will be displayed \nfor FOUR ( 4 ) SECONDS.\n\nAS EACH SCREEN APPEARS\nTRY TO PRESS THE BUTTON\nNAMED **MAIN SCREEN**\nTO STAY ALERT.\n\nPlease Respond by pressing OK\nto QUICKLY CYCLE \nthrough the CRM SCREEN VIEWS.")
      ...
      def COMMAND_CENTER_STARTUP_method(self):  
          ...
          window_select_global = "COMMAND CENTER"
          self.window_select_opt_menu_select.set(str(window_select_global) )

          
          self.after(1000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(2000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(3000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(4000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(5000, lambda: self.COMMAND_CENTER_yellow_red_button() )

          self.after(6000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(7000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(8000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(9000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(10000, lambda: self.COMMAND_CENTER_yellow_red_button() )

          self.after(11000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(12000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(13000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(14000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(15000, lambda: self.COMMAND_CENTER_yellow_red_button() )

          self.after(16000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(17000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(18000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(19000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(20000, lambda: self.COMMAND_CENTER_yellow_red_button() )

          self.after(21000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(22000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(23000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(24000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(25000, lambda: self.COMMAND_CENTER_yellow_red_button() )

          self.after(26000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(27000, lambda: self.COMMAND_CENTER_blue_1_button() )
          self.after(28000, lambda: self.COMMAND_CENTER_red_button() )
          self.after(29000, lambda: self.COMMAND_CENTER_blue_2_button() )

          self.after(30000, lambda: self.COMMAND_CENTER_cyan4_button() )



      def COMMAND_CENTER_red_button(self):
          global window_select_global
          window_select_global = "COMMAND CENTER"
          self.window_select_opt_menu_select.set(str(window_select_global) )
          self.window_select_optionsmenu_inst.config(background="red4", fg="pink", font=('Helvetica', 14) )
          self.master.update()


      def COMMAND_CENTER_blue_1_button(self):
          global window_select_global
          window_select_global = "FUTURE CAPABILITY"
          self.window_select_opt_menu_select.set(str(window_select_global) )
          self.window_select_optionsmenu_inst.config(background="midnight blue", fg = "deep sky blue", font=('Helvetica', 14) )
          self.master.update()


      def COMMAND_CENTER_blue_2_button(self):
          global window_select_global
          window_select_global = "... IN VERSION 12.0"
          self.window_select_opt_menu_select.set(str(window_select_global) )
          self.window_select_optionsmenu_inst.config(background="midnight blue", fg = "deep sky blue", font=('Helvetica', 14) )
          self.master.update()


      def COMMAND_CENTER_yellow_red_button(self):
          global window_select_global
          window_select_global = "WEATHER ALERT !!!"
          self.window_select_opt_menu_select.set(str(window_select_global) )
          self.window_select_optionsmenu_inst.config(background="yellow", fg="red2", font=('Helvetica', 14) )
          self.master.update()


      def COMMAND_CENTER_cyan4_button(self):
          global window_select_global
          window_select_global = "WINDOW SELECT"
          self.window_select_opt_menu_select.set(str(window_select_global) )
          self.window_select_optionsmenu_inst.config(background="cyan4", fg="black", font=('Helvetica', 14) )
          self.master.update()
...
class USER_GUI_Config_Class(Frame):    #(object)
    ...
    def very_first_create_medical_record_config_ini(self):
        ...
        if os.path.isfile(fullpath_med_config_ini_global) == False:  # self.very_first_create_medical_record_config_ini()
            ...
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame1_user_label", "Insulin - mU/L (Fasting)")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame1_status_text", "Enter Fasting Insulin Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame1_user_button", "Record Insulin")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame2_user_label", "Insulin Resistance - mU/L (2 hrs)")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame2_status_text", "Enter Insulin Resistance below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame2_user_button", "Record Insulin Resistance")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame3_user_label", "Glucose - mg/dL (Fasting)")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame3_status_text", "Enter Glucose Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame3_user_button", "Record Glucose")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame4_user_label", "Glucose Response - mg/dL (2 hrs)")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame4_status_text", "Enter Glucose Response below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame4_user_button", "Record Glucose Response")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame5_user_label", "LDL-Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame5_status_text", "Enter LDL-Cholesterol below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame5_user_button", "Record LDL-Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame6_user_label", "Total Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame6_status_text", "Enter Total Cholesterol below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame6_user_button", "Record Total Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame7_user_label", "HDL-Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame7_status_text", "Enter HDL-Cholesterol below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame7_user_button", "Record HDL-Cholesterol")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame8_user_label", "Triglycerides")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame8_status_text", "Enter Triglycerides below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame8_user_button", "Record Triglycerides")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame9_user_label", "Body Weight")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame9_status_text", "Enter Body Weight below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame9_user_button", "Record Body Weight")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame10_user_label", "Body Height")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame10_status_text", "Enter Body Height below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame10_user_button", "Record Body Height")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame11_user_label", "Resting Heart Rate")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame11_status_text", "Enter Resting Heart Rate below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame11_user_button", "Record Resting Heart Rate")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame12_user_label", "Blood Press - (Sys/Dias) - mm Hg")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame12_status_text", "Enter Blood Pressure below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group4_frame12_user_button", "Record Blood Pressure")

            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame1_user_label", "Serum Creatinine - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame1_status_text", "Enter Serum Creatinine below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame1_user_button", "Record Serum Creatinine")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame2_user_label", "Blood Urea Nitrogen - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame2_status_text", "Enter Blood Urea Nitrogen below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame2_user_button", "Record Blood Urea Nitrogen")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame3_user_label", "Serum Albumin - g/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame3_status_text", "Enter Serum Albumin Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame3_user_button", "Record Serum Albumin")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame4_user_label", "Globulin - g/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame4_status_text", "Enter Globulin Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame4_user_button", "Record Globulin")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame5_user_label", "Urine Protein  - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame5_status_text", "Enter Urine Protein Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame5_user_button", "Record Urine Protein")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame6_user_label", "Total Bilirubin - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame6_status_text", "Enter Total Bilirubin below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame6_user_button", "Record Total Bilirubin")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame7_user_label", "Direct Bilirubin - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame7_status_text", "Enter Direct-Bilirubin below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame7_user_button", "Record Direct-Bilirubin")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame8_user_label", "AST - IU/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame8_status_text", "Enter AST below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame8_user_button", "Record AST")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame9_user_label", "ALT - IU/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame9_status_text", "Enter ALT below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame9_user_button", "Record ALT")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame10_user_label", "GGT - IU/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame10_status_text", "Enter GGT Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame10_user_button", "Record GGT")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame11_user_label", "ALP - U/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame11_status_text", "Enter ALP Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame11_user_button", "Record ALP")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame12_user_label", "25(OH)D (Vitamin D3) - ng/ml")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame12_status_text", "Enter 25(OH)D (Vitamin D3) below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group5_frame12_user_button", "Record 25(OH)D (Vitamin D3)")

            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame1_user_label", "Sodium - mmol/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame1_status_text", "Enter Sodium Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame1_user_button", "Record Sodium")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame2_user_label", "Potasium - mmol/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame2_status_text", "Enter Potasium Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame2_user_button", "Record Potasium")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame3_user_label", "Chloride - mmol/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame3_status_text", "Enter Chloride Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame3_user_button", "Record Chloride")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame4_user_label", "Bicarbonate - mmol/L")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame4_status_text", "Enter Bicarbonate Levels below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame4_user_button", "Record Bicarbonate")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame5_user_label", "Calcium - mg/dL")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame5_status_text", "Enter Calium Level below ...")
            very_first_medical_config.set("USER_DESIGNS_GUI", "group6_frame5_user_button", "Record Calcium")
    ...
    def lift_group_four_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP FOUR BUTTON - gui_group_four_object.lift() - " + str(gui_group_four_object) )
    ...
    def lift_group_five_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP FIVE BUTTON - gui_group_five_object.lift() - " + str(gui_group_five_object) )
    ...
    def lift_group_six_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP SIX BUTTON - gui_group_six_object.lift() - " + str(gui_group_six_object) )
    ...
    def lift_group_seven_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP SEVEN BUTTON - gui_group_seven_object.lift() - " + str(gui_group_seven_object) )
    ...
    def lift_group_eight_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP EIGHT BUTTON - gui_group_eight_object.lift() - " + str(gui_group_eight_object) )
    ...
    def lift_group_nine_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP NINE BUTTON - gui_group_nine_object.lift() - " + str(gui_group_nine_object) )
    ...
    def lift_group_ten_WINDOW(self, event):
        ...
        print(".... COMMAND *** L I F T *** GROUP TEN BUTTON - gui_group_ten_object.lift() - " + str(gui_group_ten_object) )
...
class Write_Exception_Logfile(object):
      ...
      def write_update_exception_logfile(self):
            with open(str(fullpath_exception_logfile_global), 'a') as exception_logfile:
                  ...
                  exception_logfile.write("\n_____________________________________________________________________________\n")
                  exception_logfile.write("\n" + ".... Contact  Management  Workstation  Enterprise  Cloud  Software  Application: *** Version 12.0 ***")
