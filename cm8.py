...
class App(object):
      ...
      def __init__(self, master):
            ...
            self.excel_import_export_button = Button(self.master, text = "E x c e l\nImport / Export", \
            ...
            *List_of_Program_Modes, command=self.func_set_mode_select_global)
            ...
            self.new_window_button = Button(self.master, text = "SELECT\nContact\nList", \
                  width = 8, height = 4, font=minilarge_font, background="dark slate gray", \
...
###################################################################################### 
            ...
            self.app_media_button = Button(self.master, text = "APP MEDIA", \
