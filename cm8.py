...
class App(object):
      ...
      def __init__(self, master):
            ...
            self.mybutton = Button(self.master, text = "SAVE\nContact\nEntry", \
                  ...
                  background="light sea green", command = self.decision_SAVE_CONTACT_ENTRY)
...
###########################################################################################################
      ...
      def edit_mode_contact_update(self):
            ...
            # 
            print("\n\n") 
            print(self.entry_first.get() )
            print(self.entry_first.get() )
            print(self.entry_last.get() )
            print(self.entry_streetadd.get() )
            print(self.entry_citytown.get() )
            print(self.entry_state.get() )
            print(self.entry_zipcode.get() )
            print(self.entry_phonenum.get() )
            print(self.entry_email.get() )
            print(self.entry_website.get() )
            print(self.contact_dict_count_status.get() )

            print("\n\n")
            print(".... mode_select_global = " + str(mode_select_global) + str("\n") )
            print(".... Look at POINTERS when SAVE  CONTACT ENTRY is PRESSED." + str("\n") )
            print("selected_dictionary_record_index_global = " + str(selected_dictionary_record_index_global) )
...
class Demo5(object):
    def __init__(self, master):
        ...
        ## self.reserve_row_zero_button.bind("<Button-1>",self.convert_CSV_to_Excel)

        #   E X P O R T   D A T A   WIDGET GROUP

        # Button Widget for EXPORT SIGN.
        ...
        ## self.reserve_row_three_button.bind("<Button-1>",self.convert_CSV_to_Excel)

        #   I M P O R T   D A T A   WIDGET GROUP  

        # Button Widget for IMPORT SIGN.
        ...
        ## self.select_import_file_button.bind("<Button-1>",self.convert_CSV_to_App_Contact_List)

        # TEXTBOX to insert TITLE at top of window 

        self.title_1_import_text_box = Text(self.master, width=90, height = 2)
        self.title_1_import_text_box.grid(row=4, column=1, sticky = W)
        self.title_1_import_text_box.config(borderwidth=10, font=('Helvetica', '14'), background="light sea green")
        ...
        self.title_2_import_text_box.config(borderwidth=10, font=('Helvetica', '14'), background="light sea green")

        text_2_TITLE = "  Click the IMPORT from Excel button and Select CSV File from Dialog Windows to import to selected Contact List.\n  Note:  The Excel CSV File you SELECT to IMPORT will also be copied to Windows Folder:\n  " + str(import_excel_csv_userprofile_global)
    ...
    def convert_CSV_to_App_Contact_List(self, event):
        ...
        # Open variable-based csv, iterate over the rows and 
        # map values to a list of dictionaries containing key/value pairs.
        ...
        print(".... CSV as LIST of DICTIONARIES  -  C O N T A C T S  :" + "\n")
            
        pprint.pprint(dict_list)  

        print("\n\n")

        print(".... WE ARE IN THE  I M P O R T   Method  .... " + str("\n\n") )
