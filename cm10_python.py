...
class Demo2_List_Builder(object):
    ...
    def start_build_list_WORKFLOW(self):
        ...
        # we bring our select-a-list button alive 
        ...
        # we bring our COMMAND BUTTONS alive over LBOX1, LBOX2, and LBOX3
        # which enables the Merge List Workflow.
            ...
            #
            #  WE SWITCH TO THE WORKFLOW CANVAS WIDGET ..... 
            #
            self.draw_WorkFlow_Canvas_Widget()
            #
    ...
    def draw_WorkFlow_Canvas_Widget(self):
        ...
        self.label_workflow_start.config(bg="magenta", fg='cyan')  
...
#12345678   
        ...
        print(".... ")
        print(".... ***** VERIFY MERGED DICTIONARY ON MAIN SCREEN IS GOOD *****")
        print(".... ")
        print(".... ***** VERIFY MERGED DICTIONARY IS THE NEW GLOBAL *****")
#12345678
