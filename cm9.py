...
class Demo2_List_Builder(object):
    def __init__(self, master):
        ...
        self.source_file_status_text_box.config(borderwidth=10, font=('Helvetica', '12'), background="light sea green")
        ...
        self.lbox_Source_Contacts = Listbox(self.master, width=42, height = 22)
        ...
        self.lbox_Destination_Contacts = Listbox(self.master, width=42, height = 22)
...
#123456789012
    ...
    def get_Listbox_File(self, event):
        ...
        # set to green to focus user on next task
        self.my_cm_filename_entry.config(background = "light sea green")
    ...
    def OnListBoxSelect(self, event):
        ...
        self.lbox_Destination_Contacts.insert(0, contact_string_value)
