...
class Demo2_List_Builder(object):
    def __init__(self, master):
        ...
        self.select_file_button = Button(self.master, text = "Click Here after SELECTING\na CONTACT LIST\nto BUILD from", \
            width=28,height=3, font=('Helvetica', '12'), background="light sea green" ) # command = self.get_Listbox_File
        ...
        self.completed_new_contact_list_name_button = Button(self.master, textvariable=self.new_list_button_text, \
            width=36,height=3, font=('Helvetica', '12'), background="light sea green", command = self.enter_new_contact_list_name)
        ...
        self.my_cm_filename_entry.config(borderwidth=10, background="light sea green")
        

        self.create_the_new_dictionary_button = Button(self.master, text = "Click Here when finished\nSELECTING CONTACTS\nto CREATE your NEW LIST", \
            width=28,height=3, font=('Helvetica', '12'), background="light sea green", command = self.create_the_NEW_DICTIONARY)
        ...
        self.final_build_status_text_box.config(borderwidth=10, font=('Helvetica', '12'), background="light sea green")
        ...
        self.lbox_Source_Contacts.config(borderwidth=10, font=('Helvetica', '12'), background="light sea green") 
        ...
        self.lbox_Destination_Contacts.config(borderwidth=10, font=('Helvetica', '12'), background="light sea green") 
    ...
    def enter_new_contact_list_name(self):
        ...
        if test_entry_value != "":
            ...
            self.entry_CM_FILENAME.set(self.BUILDING_NEW_LIST_NAME_ONLY)
...
#.... contact_string_value = widget.get(selection[0]) = Tim9 EEEE9 othermail@gmail.com9
    ...
    def capture_new_contact_list_name(self):
        ...
        self.BUILDING_NEW_LIST_NAME_ONLY = self.my_cm_filename_entry.get()
        textbox_newfile_capture_global = True
        ...
        if self.BUILDING_NEW_LIST_NAME_ONLY == "":
              self.BUILDING_NEW_LIST_NAME_ONLY = "Build_List_" + str(time_string)
