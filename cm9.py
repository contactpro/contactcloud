        ...
        for record_index in range (1, self.num_data_records_plus_one):
             ...
             for key_index in range (1, 10):
                   ...
                   if key_index == 8:  # EMAIL
                         em_sub_string = key_indexed_string + str(" ") + "DR_" + str(record_index)
                   if key_index == 9:
                         pass
...
#12345678
        ...
        # A T T E N T I O N :  
        #
        # We might someday delete this:
        
        insert_first_contact_global = True   # ADDS FIRST DICT RECORD TO AVOID KEY ERROR
         
        # if we adjust code to IMMEDIATELY WRITING TO THE DICT FILE
        # before we call any class or method that could cause the
        # DICT KEY ERROR that happens when trying to read an empty DICTIONARY.
