...
REM
vsim -c vhdl_dut_tb sv_tb_module -msgmode both -do C:\Users\HP\WORK_MODELSIM\project_one\sim\sim.do -wlf C:\Users\HP\WORK_MODELSIM\project_one\sim\dut_vhdl.wlf
REM 
